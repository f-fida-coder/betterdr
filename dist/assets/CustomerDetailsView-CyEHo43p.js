...
I need active players so if you could do me a solid and place a bet today even if it's with freeplay. Good luck! Lmk that you've read all the rules and or if you have any questions and need me to adjust anything!`,Ha=s=>!s||typeof s!="object"?s:{...s,minBet:g(s.minBet??s.defaultMinBet,0),maxBet:g(s.maxBet??s.wagerLimit??s.defaultMaxBet,0),wagerLimit:g(s.wagerLimit??s.maxBet??s.defaultMaxBet,0),creditLimit:g(s.creditLimit??s.defaultCreditLimit,0),balanceOwed:g(s.balanceOwed??s.defaultSettleLimit,0),balance:g(s.balance,0),pendingBalance:g(s.pendingBalance,0),freeplayBalance:g(s.freeplayBalance,0),lifetime:g(s.lifetime,0),lifetimePlusMinus:g(s.lifetimePlusMinus??s.lifetime,0)},un=(s,S=0)=>s===""||s===null||s===void 0?g(S,0):g(s,0),xn=s=>String(s||"").trim().toLowerCase().replace(/[^a-z0-9]+/g,""),Ja=s=>K(s?.type)==="deleted_wager"?String(s?.status||"").trim().toLowerCase()==="restored"?"Changed Wager":"Deleted Transaction":Ds(s),gn=s=>{const S=String(s?.description||"").trim();if(!S)return"—";const N=xn(S),y=xn(Ja(s));return!N||y&&(N===y||N===`${y}s`||`${N}s`===y)?"—":S},hn=s=>String(s?.actorUsername??s?.deletedByUsername??"").trim()||"—",fn=s=>{if(!s)return 0;const S=s?.$date||s,y=new Date(S).getTime();return Number.isNaN(y)?0:y},zs=s=>{const S=Math.abs(Number(s?.amount||0)),N=String(s?.sport||"").trim(),y=String(s?.reason||"").trim(),z=String(s?.status||"deleted").trim().toLowerCase()||"deleted",E=[z==="restored"?"Changed Wager":"Deleted Wager"];return N&&E.push(`(${N})`),y&&E.push(`- ${y}`),{id:`deleted-wager-${String(s?.id||"")}`,type:"deleted_wager",entrySide:"CREDIT",sourceType:null,referenceType:"DeletedWager",referenceId:s?.id||null,user:s?.user||"Unknown",userId:s?.userId||null,amount:S,date:s?.deletedAt||s?.restoredAt||null,balanceBefore:null,balanceAfter:null,status:z,reason:y?y.toUpperCase().replace(/\s+/g,"_"):null,description:E.join(" ")}},Rs=s=>{const S=K(s);return S==="betting_adjustments"||S==="credit_debit_adjustments"||S==="promotional_adjustments"?"adjustment":"all"},Is=(s,S)=>{const N=K(S);if(N===""||N==="all"||N==="all_transactions")return!0;const y=K(s?.type);return N==="non_wager"?!As.has(y):N==="deposit_withdrawal"?y==="deposit"||y==="withdrawal":N==="betting_adjustments"||N==="credit_debit_adjustments"?Fs(s):N==="promotional_adjustments"?_s(s):N==="freeplay_transactions"?qa(s):N==="wagers_only"?bn.has(y):N==="deleted_changed"||N==="deleted_transactions"?Ts.has(y):!0},$s=s=>!s||typeof s!="object"?"":String(s.userId??s.playerId??s.user?.id??s.user?.id??"").trim(),Us=s=>!s||typeof s!="object"?"":String(s.user??s.username??s.playerUsername??s.playerName??"").trim().toLowerCase(),Ga=(s,S,N,y)=>{const z=$s(s);if(z!=="")return!!(z===String(S)||y?.id&&z===String(y.id));const Q=Us(s),E=String(N||"").trim().toLowerCase();return Q!==""&&E!==""?!!(Q===E||y?.username&&Q===String(y.username).trim().toLowerCase()):!0};function ei({userId:s,onBack:S,onNavigateToUser:N,role:y="admin",viewContext:z=null}){const[Q,E]=l.useState(!0),[Ka,Qa]=l.useState(!1),[Xa,A]=l.useState(""),[et,X]=l.useState(""),[o,F]=l.useState(null),[ca,at]=l.useState({}),[G,tt]=l.useState(null),[_,yn]=l.useState([]),[n,ee]=l.useState(dn),[jn,Se]=l.useState(!1),[f,O]=l.useState("basics"),[ke,nt]=l.useState([]),[vn,Pe]=l.useState(!1),[ae,L]=l.useState(""),[st,de]=l.useState(""),[Ce,da]=l.useState("7d"),[pe,pa]=l.useState("deposit_withdrawal"),[ma,it]=l.useState("all"),[me,ua]=l.useState([]),[Nn,De]=l.useState(!1),[xa,ga]=l.useState("deposit"),[ha,ue]=l.useState(""),[rt,fa]=l.useState(""),[Le,te]=l.useState(!0),[wn,Me]=l.useState(!1),[ba,lt]=l.useState(!1),[R,Sn]=l.useState("daily"),[kn,ot]=l.useState(!1),[ct,Ae]=l.useState(""),[Te,dt]=l.useState([]),[ya,ja]=l.useState(""),[ne,Be]=l.useState([]),[We,pt]=l.useState([]),[Pn,Ee]=l.useState(!1),[se,C]=l.useState(""),[mt,ie]=l.useState(""),[Fe,Cn]=l.useState("7d"),[xe,va]=l.useState([]),[Dn,ge]=l.useState(!1),[re,ut]=l.useState("deposit"),[Na,wa]=l.useState(""),[_e,xt]=l.useState(""),[Ln,Oe]=l.useState(!1),[gt,ht]=l.useState(!1),[ft,ze]=l.useState(""),[bt,yt]=l.useState(""),[jt,vt]=l.useState(!1),[Nt,Re]=l.useState(""),[wt,St]=l.useState(""),[kt,Ie]=l.useState(""),[I,$]=l.useState(null),[Pt,Ct]=l.useState(!1),[Dt,Lt]=l.useState(""),[$e,Sa]=l.useState(null),[D,ka]=l.useState(null),[Ue,Mt]=l.useState(!1),[At,Tt]=l.useState(""),[Pa,Ye]=l.useState(!1),[Bt,le]=l.useState(""),[Wt,Ve]=l.useState(""),[He,Et]=l.useState(null),[Ca,Da]=l.useState(""),[Ys,Mn]=l.useState(""),[Vs,An]=l.useState(""),[Hs,Tn]=l.useState(""),[Ge,Ft]=l.useState(""),[Gs,Bn]=l.useState(""),[qs,Wn]=l.useState([]),[_t,En]=l.useState(""),[he,La]=l.useState(null),[Ot,zt]=l.useState(!1),[Rt,qe]=l.useState(""),[Je,It]=l.useState(null),Fn=[{id:"basics",label:"The Basics",icon:"🪪"},{id:"transactions",label:"Transactions",icon:"💳"},{id:"pending",label:"Pending",icon:"🕒"},{id:"performance",label:"Performance",icon:"📄"},{id:"analysis",label:"Analysis",icon:"📈"},{id:"freeplays",label:"Free Plays",icon:"🤲"},{id:"commission",label:"Commission",icon:"🌿"},{id:"dynamic-live",label:"Dynamic Live",icon:"🖥️"},{id:"live-casino",label:"Live Casino",icon:"🎴"},{id:"crash",label:"Crash",icon:"🚀"},{id:"player-info",label:"Player Info",icon:"ℹ️"},{id:"offerings",label:"Offerings",icon:"🔁"},{id:"limits",label:"Limits",icon:"✋"},{id:"vig-setup",label:"Vig Setup",icon:"🛡️"},{id:"parlays",label:"Parlays",icon:"🔢"},{id:"teasers",label:"Teasers",icon:"8️⃣"},{id:"buying-pts",label:"Buying Pts",icon:"🛒"},{id:"risk-mngmt",label:"Risk Mngmt",icon:"💲"},{id:"communication",label:"Communication",icon:"📞"}],$t=async(a,t)=>{const i=String(t||"").trim();if(!i)return null;try{const c=await ks(a,{agentId:i}),r=Number(c?.balanceOwed);return Number.isFinite(r)?r:null}catch(c){return console.warn("Failed to load live agent settlement balance:",c),null}};l.useEffect(()=>{s&&(async()=>{try{E(!0),A(""),X(""),de(""),L(""),$(null),F(null),Sa(null),ka(null),ee(dn),O("basics");const t=localStorage.getItem("token");if(!t){A("Please login to view details.");return}const[i,c]=await Promise.all([Ua(s,t),["admin","super_agent","master_agent","agent"].includes(y)?fs(t):Promise.resolve([])]),r=i?.user,d=r?.settings||{},m=d.dynamicLiveLimits||{},p=d.dynamicLiveFlags||{},u=d.liveCasinoLimits||{},h=u.default||{},v=u.agent||{},j=u.player||{};if(!r){A("User not found.");return}const k=String(r?.role||"").toLowerCase(),W=k==="agent"||k==="master_agent"||k==="super_agent",P=Ha(r),oe=W?await $t(t,r.id||s):null;F(P),Sa(oe),at(i?.stats||{}),tt(i?.referredBy||null),yn(Array.isArray(c)?c:[]),W&&(Mn(r?.agentPercent!=null?String(r.agentPercent):""),An(r?.playerRate!=null?String(r.playerRate):""),Tn(r?.hiringAgentPercent!=null?String(r.hiringAgentPercent):""),Ft(P.parentAgentId||P.masterAgentId||P.createdBy?.id||P.createdBy||""),Bn(r?.subAgentPercent!=null?String(r.subAgentPercent):""),Wn(Array.isArray(r?.extraSubAgents)?r.extraSubAgents.map((V,H)=>({id:H,name:V.name||"",percent:V.percent!=null?String(V.percent):""})):[])),ee({password:"",firstName:P.firstName||"",lastName:P.lastName||"",phoneNumber:P.phoneNumber||"",minBet:P.minBet,agentId:W?P.parentAgentId||P.masterAgentId||"":y==="admin"?P.masterAgentId||P.agentId?.id||P.agentId||"":P.agentId?.id||P.agentId||"",status:(P.status||"active").toLowerCase(),creditLimit:P.creditLimit,wagerLimit:P.wagerLimit,settleLimit:P.balanceOwed,accountType:d.accountType||"credit",zeroBalanceWeekly:d.zeroBalanceWeekly||"standard",tempCredit:Number(d.tempCredit||0),expiresOn:d.expiresOn||"",enableCaptcha:!!d.enableCaptcha,cryptoPromoPct:Number(d.cryptoPromoPct||0),promoType:d.promoType||"promo_credit",playerNotes:d.playerNotes||"",sportsbook:d.sports??!0,casino:d.casino??!0,horses:d.racebook??!0,messaging:d.messaging??!1,dynamicLive:d.live??!0,propPlus:d.props??!0,liveCasino:d.liveCasino??!1,freePlayPercent:Number(d.freePlayPercent??20),maxFpCredit:Number(d.maxFpCredit??0),dlMinStraightBet:Number(m.minStraightBet??25),dlMaxStraightBet:Number(m.maxStraightBet??250),dlMaxPerOffering:Number(m.maxPerOffering??500),dlMaxBetPerEvent:Number(m.maxBetPerEvent??500),dlMaxWinSingleBet:Number(m.maxWinSingleBet??1e3),dlMaxWinEvent:Number(m.maxWinEvent??3e3),dlDelaySec:Number(m.delaySec??7),dlMaxFavoriteLine:Number(m.maxFavoriteLine??-1e4),dlMaxDogLine:Number(m.maxDogLine??1e4),dlMinParlayBet:Number(m.minParlayBet??10),dlMaxParlayBet:Number(m.maxParlayBet??100),dlMaxWinEventParlay:Number(m.maxWinEventParlay??3e3),dlMaxDogLineParlays:Number(m.maxDogLineParlays??1e3),dlWagerCoolOffSec:Number(m.wagerCoolOffSec??30),dlLiveParlays:!!p.liveParlays,dlBlockPriorStart:p.blockPriorStart??!0,dlBlockHalftime:p.blockHalftime??!0,dlIncludeGradedInLimits:!!p.includeGradedInLimits,dlUseRiskLimits:!!p.useRiskLimits,casinoDefaultMaxWinDay:Number(h.maxWinDay??1e4),casinoDefaultMaxLossDay:Number(h.maxLossDay??1e4),casinoDefaultMaxWinWeek:Number(h.maxWinWeek??1e4),casinoDefaultMaxLossWeek:Number(h.maxLossWeek??1e4),casinoAgentMaxWinDay:Number(v.maxWinDay??1e3),casinoAgentMaxLossDay:Number(v.maxLossDay??1e3),casinoAgentMaxWinWeek:Number(v.maxWinWeek??5e3),casinoAgentMaxLossWeek:Number(v.maxLossWeek??5e3),casinoPlayerMaxWinDay:Number(j.maxWinDay??1e3),casinoPlayerMaxLossDay:Number(j.maxLossDay??1e3),casinoPlayerMaxWinWeek:Number(j.maxWinWeek??5e3),casinoPlayerMaxLossWeek:Number(j.maxLossWeek??5e3),appsVenmo:r.apps?.venmo||"",appsCashapp:r.apps?.cashapp||"",appsApplePay:r.apps?.applePay||"",appsZelle:r.apps?.zelle||"",appsPaypal:r.apps?.paypal||"",appsBtc:r.apps?.btc||"",appsOther:r.apps?.other||""})}catch(t){console.error("Failed to load player details:",t),A(t.message||"Failed to load details")}finally{E(!1)}})()},[y,s]);const Ma=async()=>{if(!s)return;const a=localStorage.getItem("token");if(a)try{Mt(!0),Tt("");const t=await js(s,a);ka(t)}catch(t){Tt(t.message||"Failed to load commission chain")}finally{Mt(!1)}},_n=async a=>{if(Ft(a),!a)return;const t=localStorage.getItem("token");if(t)try{Ye(!0),le(""),Ve(""),await Va(s,{parentAgentId:a},t),Ve("Master agent updated"),await Ma()}catch(i){le(i.message||"Failed to update master agent")}finally{Ye(!1)}},On=async()=>{const a=localStorage.getItem("token"),t=parseFloat(_t);if(!a||isNaN(t)||t<=0){qe("Enter a valid positive amount");return}try{zt(!0),qe(""),La(null);const i=await Ns(s,t,a);La(i)}catch(i){qe(i.message||"Calculation failed")}finally{zt(!1)}},zn=async()=>{if(!D?.upline)return;const a=localStorage.getItem("token");if(a)try{const t=D.upline.map(c=>({id:c.id,username:c.username,agentPercent:c.agentPercent})),i=await vs(t,a);It(i)}catch(t){It({isValid:!1,errors:[t.message]})}},Ut=async a=>{if(!o?.username)return[];const t=a||localStorage.getItem("token");if(!t)throw new Error("Please login to view transactions.");const i={user:o.username||"",type:Rs(pe),status:ma,time:Ce,limit:300};s&&(i.userId=s);const c=await Ya(i,t);let m=[...(Array.isArray(c?.transactions)?c.transactions:[]).filter(p=>Ga(p,s,o.username,Ta))];if(["deleted_changed","deleted_transactions"].includes(K(pe)))try{const p=await Ps({user:o.username||"",status:"all",sport:"all",time:Ce,limit:300},t),u=(Array.isArray(p?.wagers)?p.wagers:[]).filter(h=>String(h?.userId||"")===String(s)).map(zs);m=[...m,...u]}catch(p){console.warn("Deleted/Changed wagers could not be loaded:",p)}return m.filter(p=>Is(p,pe)).sort((p,u)=>fn(u?.date)-fn(p?.date))};l.useEffect(()=>{(async()=>{if(!(f!=="transactions"||!o))try{Pe(!0),L("");const t=await Ut();nt(t)}catch(t){L(t.message||"Failed to load transactions")}finally{Pe(!1)}})()},[f,o,pe,ma,Ce,s]),l.useEffect(()=>{(async()=>{if(!(f!=="performance"||!o?.username))try{ot(!0),Ae("");const t=localStorage.getItem("token");if(!t){Ae("Please login to view performance.");return}const i=await bs({customer:o.username,time:R==="weekly"?"90d":R==="yearly"?"all":"30d",type:"all-types",limit:500},t),c=Array.isArray(i?.bets)?i.bets:[],r=new Map,d=u=>{const h=new Date(Date.UTC(u.getFullYear(),u.getMonth(),u.getDate())),v=h.getUTCDay()||7;h.setUTCDate(h.getUTCDate()+4-v);const j=new Date(Date.UTC(h.getUTCFullYear(),0,1));return Math.ceil(((h-j)/864e5+1)/7)};for(const u of c){const h=u?.createdAt,v=new Date(h);if(Number.isNaN(v.getTime()))continue;let j="",k="";if(R==="daily"){const B=v.getFullYear(),we=String(v.getMonth()+1).padStart(2,"0"),ce=String(v.getDate()).padStart(2,"0");j=`${B}-${we}-${ce}`,k=v.toLocaleDateString("en-US",{month:"2-digit",day:"2-digit",year:"numeric",weekday:"long"})}else if(R==="weekly"){const B=v.getFullYear(),we=String(d(v)).padStart(2,"0");j=`${B}-W${we}`;const ce=new Date(v),rn=ce.getDay(),hs=ce.getDate()-rn+(rn===0?-6:1);ce.setDate(hs),k=`Week of ${ce.toLocaleDateString("en-US",{month:"2-digit",day:"2-digit",year:"numeric"})}`}else if(R==="monthly"){const B=v.getFullYear(),we=String(v.getMonth()+1).padStart(2,"0");j=`${B}-${we}`,k=v.toLocaleDateString("en-US",{month:"long",year:"numeric"})}else{const B=v.getFullYear();j=`${B}`,k=`${B}`}const W=Number(u?.amount||0),P=Number(u?.potentialPayout||0),oe=String(u?.status||"").toLowerCase(),V=oe==="won"?Math.max(0,P-W):oe==="lost"?-W:0;r.has(j)||r.set(j,{date:v,net:0,wagers:[],periodLabel:k});const H=r.get(j);H.net+=V,H.wagers.push({id:u.id||`${j}-${H.wagers.length+1}`,label:`${u?.match?.awayTeam||""} vs ${u?.match?.homeTeam||""}`.trim()||u.selection||"Wager",amount:V})}const m=Array.from(r.entries()).map(([u,h])=>({key:u,date:h.date,periodLabel:h.periodLabel,net:h.net,wagers:h.wagers})).sort((u,h)=>h.key.localeCompare(u.key));if(R==="yearly"){const u=g(o?.lifetimePlusMinus??o?.lifetime,0);if(Number.isFinite(u)){const h=m.reduce((j,k)=>j+Number(k.net||0),0),v=u-h;if(Math.abs(v)>=.01){const j=String(new Date().getFullYear());let k=m.findIndex(W=>W.key===j);k<0&&(m.unshift({key:j,date:new Date,periodLabel:j,net:0,wagers:[]}),k=0),m[k]={...m[k],net:Number(m[k].net||0)+v,wagers:[...Array.isArray(m[k].wagers)?m[k].wagers:[],{id:`lifetime-carry-${m[k].key}`,label:"Lifetime +/- Carry",amount:v,synthetic:!0}]}}}}dt(m);const p=m[0]?.key||"";ja(p),Be(m[0]?.wagers||[])}catch(t){Ae(t.message||"Failed to load performance"),dt([]),ja(""),Be([])}finally{ot(!1)}})()},[f,o?.username,o?.lifetimePlusMinus,o?.lifetime,R]),l.useEffect(()=>{(async()=>{if(!(f!=="freeplays"||!o?.username))try{Ee(!0),C("");const t=localStorage.getItem("token");if(!t){C("Please login to view free play.");return}const i=await Ya({user:o.username,type:"all",status:"all",time:Fe,limit:300},t),r=(Array.isArray(i?.transactions)?i.transactions:[]).filter(d=>Ga(d,s,o.username,Ta)&&qa(d));pt(r)}catch(t){C(t.message||"Failed to load free play")}finally{Ee(!1)}})()},[f,o?.username,Fe,s]);const x=(a,t)=>{ee(i=>({...i,[a]:t}))},Rn=a=>{$(null),ee(t=>({...t,firstName:oa(a)}))},In=a=>{$(null),ee(t=>({...t,lastName:oa(a)}))},$n=a=>{$(null),ee(t=>({...t,phoneNumber:cn(a)}))},Yt=l.useMemo(()=>{const a=`${n.firstName||""} ${n.lastName||""}`.trim();return a||(o?.fullName?o.fullName:"")},[n.firstName,n.lastName,o?.fullName]);l.useMemo(()=>Yt||o?.username||"Player",[Yt,o?.username]);const Vt=l.useMemo(()=>on(n.firstName,n.lastName,n.phoneNumber,o?.username||""),[n.firstName,n.lastName,n.phoneNumber,o?.username]),Aa=l.useMemo(()=>o?Vt||o.displayPassword||"Not set":"",[o,Vt]),Ht=l.useMemo(()=>{const a=new Set;return(Array.isArray(I?.matches)?I.matches:[]).forEach(i=>{(Array.isArray(i?.matchReasons)?i.matchReasons:[]).forEach(r=>{const d=String(r||"").trim().toLowerCase();d&&a.add(d)})}),a},[I]),Un=Ht.has("phone"),Yn=Ht.has("password"),Vn=l.useMemo(()=>{const a=String(o?.role||"player").toLowerCase();return a==="user"||a==="player"?"PLAYER":a.replace(/_/g," ").toUpperCase()},[o?.role]),b=l.useMemo(()=>{const a=String(o?.role||"player").toLowerCase();return a==="agent"||a==="master_agent"||a==="master agent"||a==="super_agent"||a==="super agent"},[o?.role]),Ta=l.useMemo(()=>{if(!b||!o?.username||!_?.length)return null;const a=String(o.username).toUpperCase();if(a.endsWith("MA")){const t=a.slice(0,-2),i=_.find(c=>String(c.username||"").toUpperCase()===t);return i?{id:i.id,username:t}:null}else{const t=a+"MA",i=_.find(c=>String(c.username||"").toUpperCase()===t);return i?{id:i.id,username:t}:null}},[b,o?.username,_]);l.useMemo(()=>{if(!Ge)return"";const a=_.find(t=>t.id===Ge);return a?String(a.username||"").toUpperCase():String(o?.createdByUsername||o?.createdBy?.username||"").toUpperCase()},[Ge,_,o]);const U=g(o?.balance,0),fe=g(o?.pendingBalance,0),Gt=g(o?.freeplayBalance,0),qt=g(o?.lifetimePlusMinus??o?.lifetime,0),be=un(n.creditLimit,o?.creditLimit??o?.defaultCreditLimit),Ba=un(n.settleLimit,o?.balanceOwed??o?.defaultSettleLimit),Wa=g(o?.minBet??o?.defaultMinBet??n.minBet,0),Ea=g(o?.maxBet??o?.defaultMaxBet??o?.wagerLimit??n.wagerLimit,0),q=b&&$e!==null?g($e,0):U,Fa="Balance Owed / House Money",_a=l.useMemo(()=>be+U-fe,[be,U,fe]),Y=l.useMemo(()=>{let a=0;for(const t of ke)t?.status==="pending"&&String(t?.type||"").toLowerCase().includes("casino")&&(a+=Number(t.amount||0));return{pending:fe,available:b?U:Number(_a||0),carry:b&&$e!==null?q:U,nonPostedCasino:a}},[ke,fe,U,_a,b,$e,q]),Jt=a=>Math.round(g(a,0)),Oa=a=>String(Math.abs(Jt(a))),w=a=>"$"+Jt(a).toLocaleString("en-US"),M=a=>{const t=g(a,0);return`$${Math.round(t).toLocaleString("en-US")}`},Hn=async()=>{Lt(""),Ct(!0);try{const a=localStorage.getItem("token");if(!a)throw new Error("No admin token found. Please log in again.");const t=await ys(s,a);if(!t?.token)throw new Error("Login failed: no token returned from server.");if(!sessionStorage.getItem("impersonationBaseToken")){sessionStorage.setItem("impersonationBaseToken",a);const r=localStorage.getItem("userRole")||"";r&&sessionStorage.setItem("impersonationBaseRole",r)}localStorage.setItem("token",t.token),localStorage.setItem("userRole",String(t?.role||"user")),localStorage.removeItem("user");const i=String(t?.role||"").toLowerCase();let c="/";i==="admin"?c="/admin/dashboard":i==="agent"?c="/agent/dashboard":(i==="master_agent"||i==="super_agent")&&(c="/super_agent/dashboard"),window.location.href=c}catch(a){Lt(a.message||"Failed to login as user. Please try again."),Ct(!1)}},za=String(G?.id||"").trim(),Gn=l.useMemo(()=>{if(!G)return"—";const a=G.firstName||"",t=G.lastName||"";return[a,t].filter(Boolean).join(" ").trim()||G.username||G.id||"—"},[G]),Ze=za!==""&&za!==String(s||"").trim()&&typeof N=="function",qn=()=>{Ze&&N(za)},Jn=async()=>{const a=Wa,t=Ea,i=be,c=Ba,r=String(Aa??""),d=String(o?.role||"").toLowerCase(),m=d==="user"||d==="player"||d==="",p="https://bettorplays247.com",u=m?["Here's your account info. PLEASE READ ALL RULES THOROUGHLY.","",`Login: ${o?.username||""}`,`Password: ${r}`,`Min bet: ${M(a)}`,`Max bet: ${M(t)}`,`Credit: ${M(i)}`,`Settle: +/- ${M(c)}`,"",`Site: ${p}`,"",Os]:[`Login: ${o?.username||""}`,`Password: ${r}`,`Min bet: ${M(a)}`,`Max bet: ${M(t)}`,`Credit: ${M(i)}`,`Settle: +/- ${M(c)}`,"",`Site: ${p}`],h=u.join(`
`),j=`<div style="font-family:sans-serif;white-space:pre-wrap;">${u.map(k=>k===""?"<br>":k).join("<br>")}</div>`;try{typeof ClipboardItem<"u"&&navigator.clipboard.write?await navigator.clipboard.write([new ClipboardItem({"text/plain":new Blob([h],{type:"text/plain"}),"text/html":new Blob([j],{type:"text/html"})})]):await navigator.clipboard.writeText(h),Ie("All details copied"),window.setTimeout(()=>Ie(""),1400)}catch{Ie("Copy failed"),window.setTimeout(()=>Ie(""),1400)}},Zn=async()=>{try{Qa(!0),A(""),X(""),$(null);const a=localStorage.getItem("token");if(!a){A("Please login again.");return}const t=oa(n.firstName).trim(),i=oa(n.lastName).trim(),c=cn(n.phoneNumber).trim(),r=b?"":on(t,i,c,o?.username||"");if(!b&&(!t||!i||!c||!r)){A("First name, last name, and phone number are required to generate password.");return}const d={firstName:t,lastName:i,phoneNumber:c,fullName:`${t} ${i}`.trim(),password:r,allowDuplicateSave:!0,status:n.status,minBet:Number(n.minBet||0),creditLimit:Number(n.creditLimit||0),maxBet:Number(n.wagerLimit||0),wagerLimit:Number(n.wagerLimit||0),balanceOwed:Number(n.settleLimit||0),settings:{accountType:n.accountType,zeroBalanceWeekly:n.zeroBalanceWeekly,tempCredit:Number(n.tempCredit||0),expiresOn:n.expiresOn||"",enableCaptcha:!!n.enableCaptcha,cryptoPromoPct:Number(n.cryptoPromoPct||0),promoType:n.promoType,playerNotes:n.playerNotes,sports:!!n.sportsbook,casino:!!n.casino,racebook:!!n.horses,messaging:!!n.messaging,live:!!n.dynamicLive,props:!!n.propPlus,liveCasino:!!n.liveCasino}};d.apps={venmo:n.appsVenmo||"",cashapp:n.appsCashapp||"",applePay:n.appsApplePay||"",zelle:n.appsZelle||"",paypal:n.appsPaypal||"",btc:n.appsBtc||"",other:n.appsOther||""},["admin","super_agent","master_agent"].includes(y)&&n.agentId&&(d.agentId=n.agentId);let m=null;if(b){const h={firstName:t,lastName:i,fullName:`${t} ${i}`.trim(),phoneNumber:c,defaultMinBet:Number(n.minBet||0),defaultMaxBet:Number(n.wagerLimit||0),defaultCreditLimit:Number(n.creditLimit||0),defaultSettleLimit:Number(n.settleLimit||0)};n.agentId&&(h.parentAgentId=n.agentId),await Va(s,h,a),m={}}else y==="agent"?m=await ia(s,d,a):m=await ra(s,d,a);const p={...d};delete p.allowDuplicateSave,F(b?h=>({...h,firstName:p.firstName,lastName:p.lastName,fullName:p.fullName,phoneNumber:p.phoneNumber,status:p.status,defaultMinBet:Number(n.minBet||0),defaultMaxBet:Number(n.wagerLimit||0),defaultCreditLimit:Number(n.creditLimit||0),defaultSettleLimit:Number(n.settleLimit||0),minBet:Number(n.minBet||0),maxBet:Number(n.wagerLimit||0),creditLimit:Number(n.creditLimit||0),balanceOwed:Number(n.settleLimit||0),displayPassword:h?.displayPassword||""}):h=>({...h,...p,displayPassword:r||h?.displayPassword||"",settings:{...h?.settings||{},...p.settings}}));const u=m?.duplicateWarning;u&&typeof u=="object"?($({message:u.message||"Likely duplicate player detected.",matches:Array.isArray(u.matches)?u.matches:[]}),X("Changes saved with duplicate warning.")):X("Changes saved successfully.")}catch(a){console.error("Failed to save player details:",a);const t=Array.isArray(a?.duplicateMatches)?a.duplicateMatches:Array.isArray(a?.details?.matches)?a.details.matches:[];if(a?.isDuplicate===!0||a?.duplicate===!0||a?.code==="DUPLICATE_PLAYER"||a?.details?.duplicate===!0){$({message:a?.message||"Likely duplicate player detected.",matches:t}),A("");return}A(a.message||"Failed to save details")}finally{Qa(!1)}},Kn=async()=>{try{const a=localStorage.getItem("token");if(!a||!o)return;await ln(s,{balance:g(o.balance,0)},a),X("Balance updated."),A("")}catch(a){A(a.message||"Failed to update balance")}},Zt=a=>{if(!a)return"—";const t=a?.$date||a,i=new Date(t);return Number.isNaN(i.getTime())?"—":i.toLocaleString()},J=a=>{a==="transactions"?(O("transactions"),da("7d"),pa("deposit_withdrawal"),it("all")):a==="pending"?(O("transactions"),da("7d"),pa("deposit_withdrawal"),it("pending")):a==="performance"?O("performance"):a==="freeplays"?O("freeplays"):a==="dynamic-live"?O("dynamic-live"):a==="live-casino"?O("live-casino"):a==="commission"?(O("commission"),D||Ma()):O("basics"),Se(!1),X(""),de(""),A(""),$(null),L(""),Ae(""),C(""),ie(""),ze(""),yt(""),Re(""),St("")},Ke=()=>{J("transactions");const a=b?q:g(o?.balance,0),t=b?a>0?"deposit":"withdrawal":a>0?"withdrawal":"deposit";ga(t),ue(""),fa(""),te(!0),L(""),De(!0)},Kt=!!z?.autoOpenDeposit,[Qt,Qn]=l.useState(!1);l.useEffect(()=>{!Kt||Qt||o?.id&&b&&(Ke(),Qn(!0))},[Kt,Qt,o?.id,b]);const Qe=l.useMemo(()=>Te.find(a=>a.key===ya)||null,[Te,ya]);l.useEffect(()=>{if(!Qe){Be([]);return}Be(Qe.wagers||[])},[Qe]);const Xn=l.useMemo(()=>ne.reduce((a,t)=>a+Number(t.amount||0),0),[ne]),es=l.useMemo(()=>ne.filter(a=>!a?.synthetic).length,[ne]),ye=l.useMemo(()=>b?q:g(o?.balance,0),[b,q,o?.balance]),Xe=l.useMemo(()=>b?g(o?.balance,0):g(Y?.carry,0),[b,o?.balance,Y?.carry]),as=l.useMemo(()=>We.filter(a=>String(a.status||"").toLowerCase()==="pending").reduce((a,t)=>a+g(t.amount,0),0),[We]),Z=Gt,ea=a=>{const t=g(a,0);return Number.isFinite(t)?Math.round(t*100)/100:0},Xt=a=>{const t=T(a);return t==="neg"?"#dc2626":t==="pos"?"#16a34a":"#000000"},aa=a=>{const t=T(a);return t==="pos"?"neg":t==="neg"?"pos":"neutral"},ts=a=>b?aa(a):T(a),Ra=(a,t=b)=>{const i=t?aa(a):T(a);return i==="neg"?"#dc2626":i==="pos"?"#16a34a":"#000000"},Ia=b?mn:pn,en=Ia.find(a=>a.value===xa)||Ia[0],je=Number(ha||0),an=Number.isFinite(je)&&je>0,tn=an,ta=l.useMemo(()=>Ls(o,je),[o,je]),ns=re==="withdraw",$a=Number(Na||0),nn=Number.isFinite($a)&&$a>0,sn=nn,ve=async()=>{if(o?.username)try{Ee(!0);const a=localStorage.getItem("token");if(!a)return;const t=await Ya({user:o.username,type:"all",status:"all",time:Fe,limit:300},a),i=Array.isArray(t?.transactions)?t.transactions:[];pt(i.filter(c=>Ga(c,s,o.username,Ta)&&qa(c)))}catch(a){C(a.message||"Failed to refresh free play")}finally{Ee(!1)}},ss=(a,t="transaction")=>{const i=Number(a?.deleted||0),c=Number(a?.skipped||0),r=Number(a?.cascadeDeleted||0),m=(Array.isArray(a?.warnings)?a.warnings:[]).find(u=>typeof u?.message=="string"&&u.message.trim()!=="");let p=i>0?`Deleted ${i} ${t}(s).`:`No ${t}(s) were deleted.`;return r>0&&(p+=` Linked free play deleted: ${r}.`),c>0&&(p+=` Skipped ${c}.`),m&&(p+=` ${m.message}`),i>0||r>0?p+=" Balances and totals were updated.":p+=" Balances and totals were not changed.",p},na=(a,t,i,c)=>{const r=Number(a?.deleted||0),d=Number(a?.cascadeDeleted||0),m=ss(a,t);if(r>0||d>0){i(m),c("");return}i(""),c(m)},is=async()=>{try{const a=Number(Na||0);if(a<=0||Number.isNaN(a)){C("Enter a valid free play amount greater than 0.");return}const t=localStorage.getItem("token");if(!t||!o){C("Please login again.");return}const i=g(o.freeplayBalance,0),c=re==="withdraw",r=await Ss(s,{operationMode:"transaction",amount:a,direction:c?"debit":"credit",description:_e.trim()},t),d=g(r?.user?.freeplayBalance,NaN),m=r?.user?.freeplayExpiresAt??null;F(u=>u&&{...u,freeplayBalance:Number.isFinite(d)?d:ea(i+(c?-a:a)),freeplayExpiresAt:m});const p=c?"withdrawn":"added";_e.trim()?ie(`Free play ${p}. Note: "${_e.trim()}"`):ie(`Free play ${p} successfully.`),C(""),ge(!1),Oe(!1),wa(""),xt(""),await ve()}catch(a){C(a.message||"Failed to update free play")}},rs=a=>{va(t=>t.includes(a)?t.filter(i=>i!==a):[...t,a])},ls=async()=>{try{if(xe.length===0||!window.confirm(`Delete ${xe.length} selected free play transaction(s)?`))return;const a=localStorage.getItem("token");if(!a){C("Please login again.");return}const t=await la(xe,a);va([]),na(t,"free play transaction",ie,C),await ve(),await Ne(),await sa()}catch(a){C(a.message||"Failed to delete free play transactions")}},os=async a=>{try{if(!a||!window.confirm("Delete this free play transaction?"))return;const t=localStorage.getItem("token");if(!t){C("Please login again.");return}const i=await la([a],t);va(c=>c.filter(r=>r!==a)),na(i,"free play transaction",ie,C),await ve(),await Ne(),await sa()}catch(t){C(t.message||"Failed to delete free play transaction")}},cs=async()=>{try{const a=localStorage.getItem("token");if(!a){C("Please login again.");return}const t={settings:{freePlayPercent:Number(n.freePlayPercent||0),maxFpCredit:Number(n.maxFpCredit||0)}};y==="agent"?await ia(s,t,a):await ra(s,t,a),ie("Free play settings saved."),C("")}catch(a){C(a.message||"Failed to save free play settings")}},ds=async()=>{try{ht(!0);const a=localStorage.getItem("token");if(!a){ze("Please login again.");return}const t={settings:{dynamicLiveLimits:{minStraightBet:Number(n.dlMinStraightBet||0),maxStraightBet:Number(n.dlMaxStraightBet||0),maxPerOffering:Number(n.dlMaxPerOffering||0),maxBetPerEvent:Number(n.dlMaxBetPerEvent||0),maxWinSingleBet:Number(n.dlMaxWinSingleBet||0),maxWinEvent:Number(n.dlMaxWinEvent||0),delaySec:Number(n.dlDelaySec||0),maxFavoriteLine:Number(n.dlMaxFavoriteLine||0),maxDogLine:Number(n.dlMaxDogLine||0),minParlayBet:Number(n.dlMinParlayBet||0),maxParlayBet:Number(n.dlMaxParlayBet||0),maxWinEventParlay:Number(n.dlMaxWinEventParlay||0),maxDogLineParlays:Number(n.dlMaxDogLineParlays||0),wagerCoolOffSec:Number(n.dlWagerCoolOffSec||0)},dynamicLiveFlags:{liveParlays:!!n.dlLiveParlays,blockPriorStart:!!n.dlBlockPriorStart,blockHalftime:!!n.dlBlockHalftime,includeGradedInLimits:!!n.dlIncludeGradedInLimits,useRiskLimits:!!n.dlUseRiskLimits}}};y==="agent"?await ia(s,t,a):await ra(s,t,a),yt("Dynamic Live settings saved."),ze("")}catch(a){ze(a.message||"Failed to save Dynamic Live settings")}finally{ht(!1)}},ps=async()=>{try{vt(!0);const a=localStorage.getItem("token");if(!a){Re("Please login again.");return}const t={settings:{liveCasinoLimits:{default:{maxWinDay:Number(n.casinoDefaultMaxWinDay||0),maxLossDay:Number(n.casinoDefaultMaxLossDay||0),maxWinWeek:Number(n.casinoDefaultMaxWinWeek||0),maxLossWeek:Number(n.casinoDefaultMaxLossWeek||0)},agent:{maxWinDay:Number(n.casinoAgentMaxWinDay||0),maxLossDay:Number(n.casinoAgentMaxLossDay||0),maxWinWeek:Number(n.casinoAgentMaxWinWeek||0),maxLossWeek:Number(n.casinoAgentMaxLossWeek||0)},player:{maxWinDay:Number(n.casinoPlayerMaxWinDay||0),maxLossDay:Number(n.casinoPlayerMaxLossDay||0),maxWinWeek:Number(n.casinoPlayerMaxWinWeek||0),maxLossWeek:Number(n.casinoPlayerMaxLossWeek||0)}}}};y==="agent"?await ia(s,t,a):await ra(s,t,a),St("Live Casino limits saved."),Re("")}catch(a){Re(a.message||"Failed to save Live Casino limits")}finally{vt(!1)}},Ne=async()=>{if(o){Pe(!0);try{const a=localStorage.getItem("token");if(!a){L("Please login to view transactions.");return}const t=await Ut(a);nt(t)}catch(a){L(a.message||"Failed to refresh transactions")}finally{Pe(!1)}}},sa=async()=>{try{const a=localStorage.getItem("token");if(!a)return;const t=await Ua(s,a),i=t?.user;if(!i||typeof i!="object")return;const c=Ha(i),r=String(i?.role||"").toLowerCase(),m=r==="agent"||r==="master_agent"||r==="super_agent"?await $t(a,i.id||s):null;F(p=>p&&{...p,balance:c.balance,pendingBalance:c.pendingBalance,freeplayBalance:c.freeplayBalance,lifetime:c.lifetime,lifetimePlusMinus:c.lifetimePlusMinus,balanceOwed:c.balanceOwed,creditLimit:c.creditLimit,updatedAt:c.updatedAt}),Sa(m),t?.stats&&typeof t.stats=="object"&&at(t.stats),t?.referredBy!==void 0&&tt(t.referredBy||null)}catch(a){console.warn("Failed to refresh customer financials after transaction update:",a)}},ms=async()=>{if(!ba){lt(!0);try{const a=Number(ha||0);if(a<=0||Number.isNaN(a)){L("Enter a valid amount greater than 0.");return}const t=localStorage.getItem("token");if(!t||!o){L("Please login again.");return}const i=b?mn:pn,c=i.find(j=>j.value===xa)||i[0],r=g(o.balance,0),d=ea(r+(c.balanceDirection==="credit"?a:-a)),m=rt.trim();let p;b?p=await ws(s,{amount:a,direction:c.balanceDirection,type:c.apiType,description:m||c.defaultDescription},t):p=await ln(s,{operationMode:"transaction",amount:a,direction:c.balanceDirection,type:c.apiType,reason:c.reason,description:m||c.defaultDescription,applyDepositFreeplayBonus:Le},t);const u=b?0:g(p?.freeplayBonus?.amount,0),h=b?0:g(p?.referralBonus?.amount,0);F(j=>{if(!j)return j;const k=b?g(p?.agent?.balance,NaN):g(p?.user?.balance,NaN),W=Number.isFinite(k)?k:d,P=g(p?.user?.freeplayBalance,NaN),oe=Number.isFinite(P)?P:g(j.freeplayBalance,0),V=p?.user?.lifetimePlusMinus??p?.user?.lifetime??j.lifetimePlusMinus??j.lifetime??0,H=g(V,NaN),B=Number.isFinite(H)?H:g(j.lifetimePlusMinus??j.lifetime,0);return{...j,balance:W,freeplayBalance:oe,lifetime:B,lifetimePlusMinus:B}});const v=["Transaction saved and balance updated."];u>0&&v.push(`Auto free play bonus added: ${w(u)}.`),h>0&&v.push(`Referral bonus granted: ${w(h)}.`),de(v.join(" ")),L(""),De(!1),Me(!1),ga("deposit"),ue(""),fa(""),te(!0),await Ne()}catch(a){L(a.message||"Failed to save transaction")}finally{lt(!1)}}},us=a=>{ua(t=>t.includes(a)?t.filter(i=>i!==a):[...t,a])},xs=async()=>{try{if(me.length===0||!window.confirm(`Delete ${me.length} selected transaction(s)?`))return;const a=localStorage.getItem("token");if(!a){L("Please login again.");return}const t=await la(me,a);ua([]),await Ne(),await ve(),await sa(),na(t,"transaction",de,L)}catch(a){L(a.message||"Failed to delete selected transactions")}},gs=async a=>{try{if(!a||!window.confirm("Delete this transaction?"))return;const t=localStorage.getItem("token");if(!t){L("Please login again.");return}const i=await la([a],t);ua(c=>c.filter(r=>r!==a)),await Ne(),await ve(),await sa(),na(i,"transaction",de,L)}catch(t){L(t.message||"Failed to delete transaction")}};return Q?e.jsx("div",{className:"admin-view",children:e.jsx("div",{className:"view-content",children:"Loading player details..."})}):o?e.jsxs("div",{className:"customer-details-v2",children:[e.jsxs("div",{className:"top-panel",children:[e.jsxs("div",{className:"player-card",children:[e.jsx("div",{className:"player-card-head",children:e.jsxs("div",{className:"player-title-wrap",children:[e.jsxs("div",{className:"player-title-main",children:[e.jsx("span",{className:"player-kicker",children:"Player ID"}),e.jsx("h2",{children:b?(()=>{const a=String(o.username||"").toUpperCase(),t=a+"MA";return _?.find(c=>String(c.username||"").toUpperCase()===t)?`${a} (${t})`:a})():o.username||"USER"})]}),e.jsx("span",{className:"player-badge",children:Vn})]})}),e.jsxs("div",{className:"paired-grid",children:[e.jsxs("div",{className:"detail-item",children:[e.jsx("span",{className:"detail-label",children:"Login"}),e.jsx("strong",{className:"detail-value",children:o.username||""})]}),b?e.jsxs("button",{type:"button",className:`detail-item detail-metric${f==="commission"?" detail-metric-active":""}`,onClick:()=>J("commission"),children:[e.jsxs("span",{className:"detail-label",children:[String(o?.username||"Agent").toUpperCase()," %"]}),e.jsx("strong",{className:"detail-value",children:o?.agentPercent!=null?`${o.agentPercent}%`:"—"})]}):e.jsxs("button",{type:"button",className:`detail-item detail-metric${f==="transactions"?" detail-metric-active":""}`,onClick:Ke,children:[e.jsx("span",{className:"detail-label",children:"Balance"}),e.jsx("strong",{className:`detail-value ${T(U)}`,children:w(U)})]}),e.jsxs("div",{className:"detail-item",children:[e.jsx("span",{className:"detail-label",children:"Password"}),e.jsx("strong",{className:"detail-value detail-secret",children:Aa})]}),b?(()=>{const a=o?.agentPercent!=null?parseFloat(o.agentPercent):null,t=o?.hiringAgentPercent!=null?parseFloat(o.hiringAgentPercent):null,i=5,c=t!=null&&a!=null?t-a:null,r=t==null||c===0,d=!r&&t!=null?100-i-t:null,m=d!=null&&d>0,p=!r&&c>0,u=[];return p&&u.push(e.jsxs("div",{className:"detail-item detail-metric",children:[e.jsx("span",{className:"detail-label",children:"Hiring Agent %"}),e.jsxs("strong",{className:"detail-value",children:[c,"%"]})]},"hiring")),m&&u.push(e.jsxs("div",{className:"detail-item detail-metric",children:[e.jsx("span",{className:"detail-label",children:"Upline Agent %"}),e.jsxs("strong",{className:"detail-value",children:[d,"%"]})]},"upline")),u.push(e.jsxs("div",{className:"detail-item detail-metric",children:[e.jsx("span",{className:"detail-label",children:"House %"}),e.jsx("strong",{className:"detail-value",children:"5%"})]},"house")),u.push(e.jsxs("button",{type:"button",className:`detail-item detail-metric${f==="commission"?" detail-metric-active":""}`,onClick:()=>J("commission"),children:[e.jsx("span",{className:"detail-label",children:"Player Rate"}),e.jsx("strong",{className:"detail-value",children:o?.playerRate!=null?`$${o.playerRate}`:"—"})]},"prate")),e.jsxs(e.Fragment,{children:[u[0]||e.jsx("div",{className:"detail-item detail-empty","aria-hidden":"true"}),e.jsxs("div",{className:"detail-item",children:[e.jsx("span",{className:"detail-label",children:"Standard Min Bet"}),e.jsx("strong",{className:"detail-value",children:M(Wa)})]}),u[1]||e.jsx("div",{className:"detail-item detail-empty","aria-hidden":"true"}),e.jsxs("div",{className:"detail-item",children:[e.jsx("span",{className:"detail-label",children:"Standard Max Bet"}),e.jsx("strong",{className:"detail-value",children:M(Ea)})]}),u[2]||e.jsx("div",{className:"detail-item detail-empty","aria-hidden":"true"}),e.jsxs("div",{className:"detail-item",children:[e.jsx("span",{className:"detail-label",children:"Standard Credit"}),e.jsx("strong",{className:"detail-value",children:M(be)})]}),u[3]||e.jsx("div",{className:"detail-item detail-empty","aria-hidden":"true"}),e.jsxs("div",{className:"detail-item",children:[e.jsx("span",{className:"detail-label",children:"Standard Settle"}),e.jsxs("strong",{className:"detail-value",children:["+/- ",M(Ba)]})]})]})})():e.jsxs(e.Fragment,{children:[e.jsxs("button",{type:"button",className:`detail-item detail-metric${f==="transactions"&&ma==="pending"?" detail-metric-active":""}`,onClick:()=>J("pending"),children:[e.jsx("span",{className:"detail-label",children:"Pending"}),e.jsx("strong",{className:"detail-value neutral",children:w(fe)})]}),e.jsxs("div",{className:"detail-item",children:[e.jsx("span",{className:"detail-label",children:"Min Bet"}),e.jsx("strong",{className:"detail-value",children:M(Wa)})]}),e.jsxs("div",{className:"detail-item detail-metric",children:[e.jsx("span",{className:"detail-label",children:"Available"}),e.jsx("strong",{className:"detail-value neutral",children:w(_a)})]}),e.jsxs("div",{className:"detail-item",children:[e.jsx("span",{className:"detail-label",children:"Max Bet"}),e.jsx("strong",{className:"detail-value",children:M(Ea)})]}),!b&&e.jsxs("button",{type:"button",className:`detail-item detail-metric${f==="freeplays"?" detail-metric-active":""}`,onClick:()=>J("freeplays"),children:[e.jsx("span",{className:"detail-label",children:"Freeplay"}),e.jsx("strong",{className:"detail-value neutral",children:w(Gt)})]}),e.jsxs("div",{className:"detail-item",children:[e.jsx("span",{className:"detail-label",children:"Credit"}),e.jsx("strong",{className:"detail-value",children:M(be)})]}),e.jsxs("button",{type:"button",className:`detail-item detail-metric${f==="performance"?" detail-metric-active":""}`,onClick:()=>J("performance"),children:[e.jsx("span",{className:"detail-label",children:"Lifetime +/-"}),e.jsx("strong",{className:`detail-value ${T(qt)}`,children:w(qt)})]}),e.jsxs("div",{className:"detail-item",children:[e.jsx("span",{className:"detail-label",children:"Settle"}),e.jsxs("strong",{className:"detail-value",children:["+/- ",M(Ba)]})]}),e.jsxs("button",{type:"button",className:`detail-item ${Ze?"detail-link-item":""}`,onClick:qn,disabled:!Ze,children:[e.jsx("span",{className:"detail-label",children:"Referred By"}),e.jsx("strong",{className:`detail-value ${Ze?"detail-link-value":""}`,style:{fontSize:"0.8em",wordBreak:"break-all"},children:Gn})]})]}),b?e.jsxs("button",{type:"button",className:`detail-item detail-metric${f==="transactions"?" detail-metric-active":""}`,onClick:Ke,children:[e.jsx("span",{className:"detail-label",children:Fa}),e.jsx("strong",{className:`detail-value ${ts(q)}`,children:w(q)})]}):null]}),e.jsxs("div",{className:"player-card-foot",children:[e.jsxs("div",{className:"details-domain",children:[e.jsx("span",{className:"domain-label",children:"Site"}),e.jsx("span",{style:{fontWeight:700},children:"bettorplays247.com"})]}),e.jsxs("div",{className:"top-actions",children:[e.jsx("button",{className:"btn btn-copy-all",onClick:Jn,children:"Copy Details"}),e.jsx("button",{className:"btn btn-user",onClick:Hn,disabled:Pt,children:Pt?"Logging in...":"Login User"})]})]})]}),Dt&&e.jsx("div",{className:"copy-notice",style:{color:"#c0392b",background:"#ffeaea"},children:Dt}),kt&&e.jsx("div",{className:"copy-notice",children:kt})]}),e.jsxs("div",{className:"basics-header",children:[e.jsxs("div",{className:"basics-left",children:[e.jsx("button",{type:"button",className:"dot-grid-btn",onClick:()=>Se(a=>!a),"aria-label":"Open quick sections menu",children:e.jsxs("div",{className:"dot-grid","aria-hidden":"true",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})}),e.jsx("h3",{children:f==="transactions"?"Transactions":f==="performance"?"Performance":f==="freeplays"?"Free Play":f==="dynamic-live"?"Dynamic Live":f==="live-casino"?"Live Casino":f==="commission"?"Commission Tree":"The Basics"})]}),f==="transactions"?e.jsx("button",{className:"btn btn-back",onClick:Ke,children:"New transaction"}):f==="freeplays"?e.jsxs("div",{style:{display:"flex",gap:"8px"},children:[e.jsx("button",{className:"btn btn-back",onClick:()=>{ut("withdraw"),C(""),ge(!0)},children:"Withdraw"}),e.jsx("button",{className:"btn btn-save",onClick:()=>{ut("deposit"),C(""),ge(!0)},children:"Add Free Play"})]}):f==="dynamic-live"?e.jsx("button",{className:"btn btn-save",onClick:ds,disabled:gt,children:gt?"Saving...":"Save"}):f==="live-casino"?e.jsx("button",{className:"btn btn-save",onClick:ps,disabled:jt,children:jt?"Saving...":"Save"}):f==="commission"?e.jsx("button",{className:"btn btn-back",onClick:Ma,disabled:Ue,children:Ue?"Loading...":"Refresh"}):f==="performance"?e.jsx("span",{}):e.jsx("button",{className:"btn btn-save",onClick:Zn,disabled:Ka,children:Ka?"Saving...":"Save"})]}),jn&&e.jsxs(e.Fragment,{children:[e.jsx("button",{type:"button",className:"menu-backdrop",onClick:()=>Se(!1),"aria-label":"Close quick sections menu"}),e.jsxs("div",{className:"basics-quick-menu",children:[e.jsx("button",{type:"button",className:"menu-close",onClick:()=>Se(!1),"aria-label":"Close menu",children:"x"}),e.jsx("div",{className:"menu-grid",children:Fn.map(a=>e.jsxs("button",{type:"button",className:"menu-item",onClick:()=>J(a.id),children:[e.jsx("span",{className:"menu-icon",children:a.icon}),e.jsx("span",{className:"menu-label",children:a.label})]},a.id))})]})]}),f==="transactions"?ae&&e.jsx("div",{className:"alert error",children:ae}):f==="performance"?ct&&e.jsx("div",{className:"alert error",children:ct}):f==="freeplays"?se&&e.jsx("div",{className:"alert error",children:se}):f==="dynamic-live"?ft&&e.jsx("div",{className:"alert error",children:ft}):f==="live-casino"?Nt&&e.jsx("div",{className:"alert error",children:Nt}):Xa&&e.jsx("div",{className:"alert error",children:Xa}),f==="transactions"?st&&e.jsx("div",{className:"alert success",children:st}):f==="freeplays"?mt&&e.jsx("div",{className:"alert success",children:mt}):f==="dynamic-live"?bt&&e.jsx("div",{className:"alert success",children:bt}):f==="live-casino"?wt&&e.jsx("div",{className:"alert success",children:wt}):et&&e.jsx("div",{className:"alert success",children:et}),f==="basics"&&I&&e.jsxs("div",{className:"duplicate-warning-state",children:[e.jsx("div",{className:"duplicate-warning-title",children:"Duplicate Player"}),e.jsx("div",{className:"duplicate-warning-message",children:I.message}),Array.isArray(I.matches)&&I.matches.length>0&&e.jsx("div",{className:"duplicate-warning-list",children:I.matches.map((a,t)=>e.jsxs("div",{className:"duplicate-warning-item",children:[e.jsx("strong",{children:String(a.username||"UNKNOWN")}),e.jsx("span",{children:String(a.fullName||"No name")}),e.jsx("span",{children:String(a.phoneNumber||"No phone")})]},`${a.id||a.username||"duplicate"}-${t}`))})]}),f==="commission"&&e.jsxs("div",{className:"commission-section",children:[e.jsxs("div",{className:"commission-edit-card",children:[e.jsx("h4",{className:"commission-card-title",children:"Commission Settings"}),(()=>{const a=(r,d)=>{Et(r),Da(d!=null?String(d):"")},t=()=>{Et(null),Da("")},i=async()=>{const r=localStorage.getItem("token");if(!(!r||!He))try{Ye(!0);const d={};if(He==="agentPercent"){const p=parseFloat(Ca);if(isNaN(p)||p<0||p>100){le("Must be 0-100");return}d.agentPercent=p}else if(He==="playerRate"){const p=parseFloat(Ca);if(isNaN(p)||p<0){le("Must be a positive number");return}d.playerRate=p}await Va(s,d,r),le(""),Ve("Saved"),t();const m=await Ua(s,r);m?.user&&F(Ha(m.user)),ka(null),setTimeout(()=>Ve(""),2e3)}catch(d){le(d.message||"Save failed")}finally{Ye(!1)}},c=[{key:"agentPercent",label:"Agent %",value:o?.agentPercent,display:o?.agentPercent!=null?`${o.agentPercent}%`:"—",editable:!0},{key:"playerRate",label:"Player Rate",value:o?.playerRate,display:o?.playerRate!=null?`$${o.playerRate}`:"—",editable:!0}];return e.jsxs("div",{className:"commission-inline-fields",children:[c.map(r=>e.jsxs("div",{className:"commission-inline-row",children:[e.jsx("span",{className:"commission-inline-label",children:r.label}),He===r.key?e.jsxs("div",{className:"commission-inline-edit",children:[e.jsx("input",{type:"number",min:"0",max:r.key==="agentPercent"?"100":void 0,step:"0.01",className:"commission-inline-input",value:Ca,onChange:d=>Da(d.target.value),autoFocus:!0,onKeyDown:d=>{d.key==="Enter"&&i(),d.key==="Escape"&&t()}}),e.jsx("button",{className:"commission-inline-save",onClick:i,disabled:Pa,children:Pa?"...":"Save"}),e.jsx("button",{className:"commission-inline-cancel",onClick:t,children:"Cancel"})]}):e.jsxs("button",{className:"commission-inline-value",onClick:()=>r.editable&&a(r.key,r.value),children:[r.display,r.editable&&e.jsx("span",{className:"commission-inline-edit-icon",children:"✎"})]})]},r.key)),Bt&&e.jsx("div",{className:"alert error",style:{marginTop:8,fontSize:"0.85rem"},children:Bt}),Wt&&e.jsx("div",{className:"alert success",style:{marginTop:8,fontSize:"0.85rem"},children:Wt})]})})()]}),Ue&&e.jsx("div",{className:"commission-loading",children:"Loading chain..."}),At&&e.jsx("div",{className:"alert error",children:At}),D&&!Ue&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:`commission-validity-banner ${D.isValid?"valid":"invalid"}`,children:[e.jsx("span",{className:"commission-validity-icon",children:D.isValid?"✓":"!"}),e.jsxs("span",{children:["Chain total: ",e.jsxs("strong",{children:[D.chainTotal,"%"]}),D.isValid?" — Valid":" — Must equal 100%"]}),e.jsx("button",{className:"btn-text-sm",onClick:zn,style:{marginLeft:12},children:"Re-validate"})]}),Je&&e.jsx("div",{className:`commission-validity-banner ${Je.isValid?"valid":"invalid"}`,style:{marginTop:4},children:Je.isValid?"Validation passed":Je.errors?.join("; ")}),e.jsxs("div",{className:"commission-hierarchy-box",children:[D.upline.find(a=>a.role==="admin")&&e.jsxs("div",{className:"ch-row ch-row-upline",children:[e.jsx("span",{className:"ch-row-label",children:"House"}),e.jsxs("span",{className:"ch-row-username",children:["(",D.upline.find(a=>a.role==="admin").username||"—",")"]}),e.jsx("span",{className:"ch-row-pct",children:"(5%)"})]}),[...D.upline].filter((a,t)=>t>0&&a.role!=="admin").reverse().map((a,t,i)=>e.jsxs("div",{className:"ch-row ch-row-hiring",children:[e.jsx("span",{className:"ch-row-label",children:t===i.length-1?"Hiring Agent":"Upline Agent"}),e.jsxs("span",{className:"ch-row-username",children:["(",a.isSharedNode&&a.linkedUsername?`${a.username}/${a.linkedUsername}`:a.username||"—",")"]}),e.jsx("span",{className:`ch-row-pct ${a.effectivePercent==null&&a.agentPercent==null?"unset":""}`,children:a.effectivePercent!=null?`(${a.effectivePercent}%)`:a.agentPercent!=null?`(${a.agentPercent}%)`:"(not set)"}),t===i.length-1&&e.jsxs("select",{className:"ch-row-ma-select",value:Ge,onChange:c=>_n(c.target.value),disabled:Pa,children:[e.jsx("option",{value:"",children:"Change Master Agent"}),_.filter(c=>{const r=String(c.role||"").toLowerCase();return r==="master_agent"||r==="super_agent"}).map(c=>{const r=c.id;return e.jsx("option",{value:r,children:String(c.username||"").toUpperCase()},r)})]})]},a.id||t)),D.upline[0]&&e.jsxs("div",{className:"ch-row ch-row-agent",children:[e.jsx("span",{className:"ch-row-label",children:"Agent"}),e.jsxs("span",{className:"ch-row-username",children:["(",D.upline[0].isSharedNode&&D.upline[0].linkedUsername?`${D.upline[0].username}/${D.upline[0].linkedUsername}`:D.upline[0].username||"—",")"]}),e.jsx("span",{className:`ch-row-pct ${D.upline[0].agentPercent==null?"unset":""}`,children:D.upline[0].agentPercent!=null?`(${D.upline[0].agentPercent}%)`:"(not set)"})]}),D.downlines.length>0&&e.jsx("div",{className:"ch-divider"}),D.downlines.map((a,t)=>e.jsxs("div",{className:"ch-row ch-row-sub",children:[e.jsxs("span",{className:"ch-row-label",children:["Sub Agent ",t+1]}),e.jsxs("span",{className:"ch-row-username",children:["(",a.username||"—",")"]}),e.jsx("span",{className:`ch-row-pct ${a.agentPercent==null?"unset":""}`,children:a.agentPercent!=null?`(${a.agentPercent}%)`:"(not set)"}),e.jsx("span",{className:`ch-row-status ${a.status==="active"?"active":"inactive"}`,children:a.status||""})]},a.id||t)),D.downlines.length===0&&e.jsx("div",{className:"ch-row ch-row-empty",children:e.jsx("span",{className:"ch-row-label",style:{color:"#94a3b8",fontStyle:"italic"},children:"No sub-agents yet"})})]}),e.jsxs("div",{className:"commission-tree-card",children:[e.jsx("h4",{className:"commission-card-title",children:"Commission Calculator"}),e.jsx("p",{className:"commission-calc-hint",children:"Enter an amount to see how it distributes across the chain."}),e.jsxs("div",{className:"commission-calc-row",children:[e.jsx("input",{type:"number",min:"0",step:"0.01",className:"commission-input",placeholder:"Amount (e.g. 1000)",value:_t,onChange:a=>{En(a.target.value),La(null),qe("")}}),e.jsx("button",{className:"btn btn-back",onClick:On,disabled:Ot,children:Ot?"Calculating...":"Calculate"})]}),Rt&&e.jsx("div",{className:"alert error",style:{marginTop:8},children:Rt}),he&&e.jsxs("div",{className:"calc-result",children:[!he.isValid&&e.jsxs("div",{className:"alert error",style:{marginBottom:8},children:["Chain total is ",he.chainTotal,"% — percentages must sum to 100% for accurate results."]}),e.jsxs("table",{className:"commission-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Account"}),e.jsx("th",{children:"Role"}),e.jsx("th",{children:"%"}),e.jsx("th",{children:"Amount"})]})}),e.jsxs("tbody",{children:[he.distributions.map((a,t)=>e.jsxs("tr",{children:[e.jsx("td",{className:"commission-username",children:a.isSharedNode&&a.linkedUsername?`${a.username}/${a.linkedUsername}`:a.username||"—"}),e.jsx("td",{children:a.role?a.role.replace(/_/g," "):"—"}),e.jsx("td",{children:a.effectivePercent!=null?`${a.effectivePercent}%`:a.agentPercent!=null?`${a.agentPercent}%`:"—"}),e.jsxs("td",{className:"commission-amount",children:["$",Number(a.amount||0).toFixed(2)]})]},a.id||t)),e.jsxs("tr",{className:"commission-total-row",children:[e.jsx("td",{colSpan:3,children:e.jsx("strong",{children:"Total"})}),e.jsx("td",{className:"commission-amount",children:e.jsxs("strong",{children:["$",he.distributions.reduce((a,t)=>a+Number(t.amount||0),0).toFixed(2)]})})]})]})]})]})]})]})]}),f==="transactions"?e.jsxs("div",{className:"transactions-wrap",children:[e.jsxs("div",{className:"tx-controls",children:[e.jsxs("div",{className:"tx-field",children:[e.jsx("label",{children:"Display"}),e.jsxs("select",{value:Ce,onChange:a=>da(a.target.value),children:[e.jsx("option",{value:"7d",children:"Last 7 Days"}),e.jsx("option",{value:"30d",children:"Last 30 Days"}),e.jsx("option",{value:"this-month",children:"This Month"}),e.jsx("option",{value:"all",children:"All Time"})]})]}),e.jsxs("div",{className:"tx-field",children:[e.jsx("label",{children:"Filter Transactions"}),e.jsx("select",{value:pe,onChange:a=>pa(a.target.value),children:Ms.map(a=>e.jsx("option",{value:a.value,children:a.label},a.value))})]}),e.jsxs("div",{className:"tx-stat",children:[e.jsx("label",{children:"Pending"}),e.jsx("b",{children:w(Y.pending)})]}),e.jsxs("div",{className:"tx-stat",children:[e.jsx("label",{children:b?"Funding Wallet":"Available"}),e.jsx("b",{children:w(Y.available)})]}),e.jsxs("div",{className:"tx-stat",children:[e.jsx("label",{children:b?"House Money":"Carry"}),e.jsx("b",{className:b?aa(Y.carry):Y.carry<0?"neg":"",children:w(Y.carry)})]}),e.jsxs("div",{className:"tx-stat",children:[e.jsx("label",{children:"Non-Posted Casino"}),e.jsx("b",{children:w(Y.nonPostedCasino)})]})]}),e.jsx("div",{className:"tx-table-wrap",children:e.jsxs("table",{className:"tx-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Date"}),e.jsx("th",{children:"Description"}),e.jsx("th",{children:"Notes"}),e.jsx("th",{children:"Credit"}),e.jsx("th",{children:"Debit"}),e.jsx("th",{children:"Balance"}),e.jsx("th",{children:"Entered By"}),e.jsx("th",{className:"tx-actions-col",children:"Action"})]})}),e.jsx("tbody",{children:vn?e.jsx("tr",{children:e.jsx("td",{colSpan:8,className:"tx-empty",children:"Loading transactions..."})}):ke.length===0?e.jsx("tr",{children:e.jsx("td",{colSpan:8,className:"tx-empty",children:"No transactions found"})}):ke.map(a=>{const t=Cs(a),i=g(a.amount,0),c=t?0:i,r=t?i:0,d=a.balanceAfter,m=Ja(a),p=gn(a),u=hn(a),h=me.includes(a.id);return e.jsxs("tr",{className:h?"selected":"",onClick:()=>us(a.id),children:[e.jsx("td",{children:Zt(a.date)}),e.jsx("td",{children:m}),e.jsx("td",{children:p}),e.jsx("td",{children:c>0?w(c):"—"}),e.jsx("td",{children:r>0?w(r):"—"}),e.jsx("td",{className:T(d),children:d!=null?w(d):"—"}),e.jsx("td",{children:u}),e.jsx("td",{className:"tx-actions-col",children:e.jsx("button",{type:"button",className:"tx-row-delete",onClick:v=>{v.stopPropagation(),gs(a.id)},children:"Delete"})})]},a.id)})})]})}),e.jsx("button",{className:"btn btn-danger",onClick:xs,disabled:me.length===0,children:"Delete Selected"})]}):f==="performance"?e.jsxs("div",{className:"performance-wrap",children:[e.jsx("div",{className:"perf-controls",children:e.jsxs("div",{className:"tx-field",children:[e.jsx("label",{children:"Time"}),e.jsxs("select",{value:R,onChange:a=>Sn(a.target.value),children:[e.jsx("option",{value:"daily",children:"Daily"}),e.jsx("option",{value:"weekly",children:"Weekly"}),e.jsx("option",{value:"monthly",children:"Monthly"}),e.jsx("option",{value:"yearly",children:"Yearly"})]})]})}),e.jsxs("div",{className:"performance-grid",children:[e.jsx("div",{className:"perf-left",children:e.jsxs("table",{className:"perf-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Period"}),e.jsx("th",{children:"Net"})]})}),e.jsx("tbody",{children:kn?e.jsx("tr",{children:e.jsx("td",{colSpan:2,className:"tx-empty",children:"Loading performance..."})}):Te.length===0?e.jsx("tr",{children:e.jsx("td",{colSpan:2,className:"tx-empty",children:"No performance data"})}):Te.map(a=>e.jsxs("tr",{className:ya===a.key?"selected":"",onClick:()=>ja(a.key),children:[e.jsx("td",{children:a.periodLabel}),e.jsx("td",{children:Math.round(Number(a.net||0))})]},a.key))})]})}),e.jsxs("div",{className:"perf-right",children:[e.jsxs("div",{className:"perf-title-row",children:[e.jsxs("div",{children:["Wagers: ",e.jsx("b",{children:es})]}),e.jsxs("div",{children:["Result: ",e.jsx("b",{children:w(Xn)})]})]}),e.jsxs("table",{className:"perf-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:Qe?.periodLabel||"Selected Period"}),e.jsx("th",{children:"Amount"})]})}),e.jsx("tbody",{children:ne.length===0?e.jsx("tr",{children:e.jsx("td",{colSpan:2,className:"tx-empty",children:"No data available in table"})}):ne.map(a=>e.jsxs("tr",{className:a?.synthetic?"perf-synthetic":"",children:[e.jsx("td",{children:a.label||"Wager"}),e.jsx("td",{children:Math.round(Number(a.amount||0))})]},a.id))})]})]})]})]}):f==="freeplays"?e.jsxs("div",{className:"transactions-wrap",children:[e.jsxs("div",{className:"tx-controls freeplay-controls",children:[e.jsxs("div",{className:"tx-field",children:[e.jsx("label",{children:"Display"}),e.jsxs("select",{value:Fe,onChange:a=>Cn(a.target.value),children:[e.jsx("option",{value:"7d",children:"Last 7 Days"}),e.jsx("option",{value:"30d",children:"Last 30 Days"}),e.jsx("option",{value:"this-month",children:"This Month"}),e.jsx("option",{value:"all",children:"All Time"})]})]}),e.jsxs("div",{className:"tx-stat",children:[e.jsx("label",{children:"Balance"}),e.jsx("b",{children:Math.round(Number(Z))})]}),e.jsxs("div",{className:"tx-stat",children:[e.jsx("label",{children:"Pending"}),e.jsx("b",{children:Math.round(Number(as))})]})]}),e.jsx("div",{className:"tx-table-wrap",children:e.jsxs("table",{className:"tx-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Customer"}),e.jsx("th",{children:"Date"}),e.jsx("th",{children:"Description"}),e.jsx("th",{children:"Notes"}),e.jsx("th",{children:"Credit"}),e.jsx("th",{children:"Debit"}),e.jsx("th",{children:"Balance"}),e.jsx("th",{children:"Entered By"}),e.jsx("th",{className:"tx-actions-col",children:"Action"})]})}),e.jsx("tbody",{children:Pn?e.jsx("tr",{children:e.jsx("td",{colSpan:9,className:"tx-empty",children:"Loading free play..."})}):We.length===0?e.jsx("tr",{children:e.jsx("td",{colSpan:9,className:"tx-empty",children:"No free play transactions found"})}):We.map(a=>{const t=g(a.amount,0),i=g(a.balanceBefore,0),r=g(a.balanceAfter??Z,0)>=i,d=r?t:0,m=r?0:t,p=g(a?.balanceAfter??Z,0),u=Ja(a),h=gn(a),v=hn(a),j=xe.includes(a.id);return e.jsxs("tr",{className:j?"selected":"",onClick:()=>rs(a.id),children:[e.jsx("td",{children:o.username}),e.jsx("td",{children:Zt(a.date)}),e.jsx("td",{children:u}),e.jsx("td",{children:h}),e.jsx("td",{children:d>0?Math.round(d):"—"}),e.jsx("td",{children:m>0?Math.round(m):"—"}),e.jsx("td",{children:Math.round(p)}),e.jsx("td",{children:v}),e.jsx("td",{className:"tx-actions-col",children:e.jsx("button",{type:"button",className:"tx-row-delete",onClick:k=>{k.stopPropagation(),os(a.id)},children:"Delete"})})]},a.id)})})]})}),e.jsxs("div",{className:"freeplay-bottom-row",children:[e.jsx("button",{className:"btn btn-danger",onClick:ls,disabled:xe.length===0,children:"Delete Selected"}),e.jsx("button",{className:"btn btn-back freeplay-settings-btn",onClick:cs,children:"Detailed Free Play Settings"}),e.jsxs("div",{className:"freeplay-inputs",children:[e.jsxs("div",{className:"tx-field",children:[e.jsx("label",{children:"Free Play %"}),e.jsx("input",{type:"number",value:n.freePlayPercent,onChange:a=>x("freePlayPercent",a.target.value)})]}),e.jsxs("div",{className:"tx-field",children:[e.jsx("label",{children:"Max FP Credit"}),e.jsx("input",{type:"number",value:n.maxFpCredit,onChange:a=>x("maxFpCredit",a.target.value)})]})]})]})]}):f==="dynamic-live"?e.jsxs("div",{className:"dynamic-live-wrap",children:[e.jsxs("div",{className:"tx-field dl-top-select",children:[e.jsx("label",{children:"View Settings"}),e.jsx("select",{value:"wagering_limits",readOnly:!0,children:e.jsx("option",{value:"wagering_limits",children:"Wagering Limits"})})]}),e.jsxs("div",{className:"dynamic-live-grid",children:[e.jsxs("div",{className:"dl-col",children:[e.jsx("label",{children:"Min Straight Bet :"}),e.jsx("input",{type:"number",value:n.dlMinStraightBet,onChange:a=>x("dlMinStraightBet",a.target.value)}),e.jsx("label",{children:"Max Straight Bet :"}),e.jsx("input",{type:"number",value:n.dlMaxStraightBet,onChange:a=>x("dlMaxStraightBet",a.target.value)}),e.jsx("label",{children:"Max Per Offering :"}),e.jsx("input",{type:"number",value:n.dlMaxPerOffering,onChange:a=>x("dlMaxPerOffering",a.target.value)}),e.jsx("label",{children:"Max Bet Per Event :"}),e.jsx("input",{type:"number",value:n.dlMaxBetPerEvent,onChange:a=>x("dlMaxBetPerEvent",a.target.value)}),e.jsx("label",{children:"Max Win for Single Bet :"}),e.jsx("input",{type:"number",value:n.dlMaxWinSingleBet,onChange:a=>x("dlMaxWinSingleBet",a.target.value)}),e.jsx("label",{children:"Max Win for Event :"}),e.jsx("input",{type:"number",value:n.dlMaxWinEvent,onChange:a=>x("dlMaxWinEvent",a.target.value)}),e.jsx("label",{children:"Delay (sec) - minimum 5 :"}),e.jsx("input",{type:"number",value:n.dlDelaySec,onChange:a=>x("dlDelaySec",a.target.value)})]}),e.jsxs("div",{className:"dl-col",children:[e.jsx("label",{children:"Max Favorite Line :"}),e.jsx("input",{type:"number",value:n.dlMaxFavoriteLine,onChange:a=>x("dlMaxFavoriteLine",a.target.value)}),e.jsx("label",{children:"Max Dog Line :"}),e.jsx("input",{type:"number",value:n.dlMaxDogLine,onChange:a=>x("dlMaxDogLine",a.target.value)}),e.jsx("label",{children:"Min Parlay Bet :"}),e.jsx("input",{type:"number",value:n.dlMinParlayBet,onChange:a=>x("dlMinParlayBet",a.target.value)}),e.jsx("label",{children:"Max Parlay Bet :"}),e.jsx("input",{type:"number",value:n.dlMaxParlayBet,onChange:a=>x("dlMaxParlayBet",a.target.value)}),e.jsx("label",{children:"Max Win for Event(parlay only) :"}),e.jsx("input",{type:"number",value:n.dlMaxWinEventParlay,onChange:a=>x("dlMaxWinEventParlay",a.target.value)}),e.jsx("label",{children:"Max Dog Line (Parlays) :"}),e.jsx("input",{type:"number",value:n.dlMaxDogLineParlays,onChange:a=>x("dlMaxDogLineParlays",a.target.value)}),e.jsx("label",{children:"Wager Cool-Off (sec) :"}),e.jsx("input",{type:"number",value:n.dlWagerCoolOffSec,onChange:a=>x("dlWagerCoolOffSec",a.target.value)})]}),e.jsx("div",{className:"dl-col-toggles",children:[["Live Parlays","dlLiveParlays"],["Block Wagering Prior To Start","dlBlockPriorStart"],["Block Wagering at Halftime","dlBlockHalftime"],["Include Graded Wagers in Limits","dlIncludeGradedInLimits"],["Use Risk (not Volume) for Limits","dlUseRiskLimits"]].map(([a,t])=>e.jsxs("div",{className:"switch-row",children:[e.jsxs("span",{children:[a," :"]}),e.jsxs("label",{className:"switch",children:[e.jsx("input",{type:"checkbox",checked:!!n[t],onChange:i=>x(t,i.target.checked)}),e.jsx("span",{className:"slider"})]})]},t))})]})]}):f==="live-casino"?e.jsxs("div",{className:"live-casino-wrap",children:[e.jsxs("div",{className:"live-casino-grid",children:[e.jsx("div",{}),e.jsx("div",{className:"lc-col-head",children:"Default"}),e.jsx("div",{className:"lc-col-head",children:"Agent"}),e.jsx("div",{className:"lc-col-head",children:"Player"}),e.jsx("div",{className:"lc-label",children:"Max Win Per Day"}),e.jsx("input",{type:"number",value:n.casinoDefaultMaxWinDay,onChange:a=>x("casinoDefaultMaxWinDay",a.target.value)}),e.jsx("input",{type:"number",value:n.casinoAgentMaxWinDay,onChange:a=>x("casinoAgentMaxWinDay",a.target.value)}),e.jsx("input",{type:"number",value:n.casinoPlayerMaxWinDay,onChange:a=>x("casinoPlayerMaxWinDay",a.target.value)}),e.jsx("div",{className:"lc-label",children:"Max Loss Per Day"}),e.jsx("input",{type:"number",value:n.casinoDefaultMaxLossDay,onChange:a=>x("casinoDefaultMaxLossDay",a.target.value)}),e.jsx("input",{type:"number",value:n.casinoAgentMaxLossDay,onChange:a=>x("casinoAgentMaxLossDay",a.target.value)}),e.jsx("input",{type:"number",value:n.casinoPlayerMaxLossDay,onChange:a=>x("casinoPlayerMaxLossDay",a.target.value)}),e.jsx("div",{className:"lc-label",children:"Max Win Per Week"}),e.jsx("input",{type:"number",value:n.casinoDefaultMaxWinWeek,onChange:a=>x("casinoDefaultMaxWinWeek",a.target.value)}),e.jsx("input",{type:"number",value:n.casinoAgentMaxWinWeek,onChange:a=>x("casinoAgentMaxWinWeek",a.target.value)}),e.jsx("input",{type:"number",value:n.casinoPlayerMaxWinWeek,onChange:a=>x("casinoPlayerMaxWinWeek",a.target.value)}),e.jsx("div",{className:"lc-label",children:"Max Loss Per Week"}),e.jsx("input",{type:"number",value:n.casinoDefaultMaxLossWeek,onChange:a=>x("casinoDefaultMaxLossWeek",a.target.value)}),e.jsx("input",{type:"number",value:n.casinoAgentMaxLossWeek,onChange:a=>x("casinoAgentMaxLossWeek",a.target.value)}),e.jsx("input",{type:"number",value:n.casinoPlayerMaxLossWeek,onChange:a=>x("casinoPlayerMaxLossWeek",a.target.value)})]}),e.jsx("p",{className:"lc-note",children:"*Players that do not have a limit will be assigned the default limit or agent limit if one exists. Once player limits are assigned they will have to be manually overridden either by changing them individually or by changing an agent and sending through the new default limits they want to apply."})]}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"basics-grid",children:[e.jsxs("div",{className:"col-card",children:[e.jsx("label",{children:"First Name"}),e.jsx("input",{value:n.firstName,placeholder:"Enter first name",onChange:a=>Rn(a.target.value)}),e.jsx("label",{children:"Last Name"}),e.jsx("input",{value:n.lastName,placeholder:"Enter last name",onChange:a=>In(a.target.value)}),e.jsx("label",{children:"Phone Number"}),e.jsx("input",{type:"tel",value:n.phoneNumber,placeholder:"Enter phone number",onChange:a=>$n(a.target.value),className:Un?"duplicate-input":""}),e.jsxs("label",{children:["Password ",e.jsx("span",{className:"lock-badge",children:"Locked"})]}),e.jsx("input",{value:Aa,readOnly:!0,placeholder:"Auto-generated from identity",className:`password-input-dark ${Yn?"duplicate-input":""}`}),e.jsx("label",{children:"Master Agent"}),["admin","super_agent","master_agent"].includes(y)?e.jsxs("select",{value:n.agentId,onChange:a=>x("agentId",a.target.value),children:[e.jsx("option",{value:"",children:"None"}),_.filter(a=>{const t=String(a.role||"").toLowerCase();return t==="master_agent"||t==="super_agent"}).map(a=>{const t=a.id;return e.jsx("option",{value:t,children:a.username},t)})]}):e.jsx("input",{value:o.masterAgentUsername||o.agentUsername||"—",readOnly:!0}),e.jsx("label",{children:"Account Status"}),e.jsxs("select",{value:n.status,onChange:a=>x("status",a.target.value),children:[e.jsx("option",{value:"active",children:"Active"}),e.jsx("option",{value:"disabled",children:"Disabled"}),e.jsx("option",{value:"read_only",children:"Read Only"})]}),e.jsx("div",{className:"switch-list",children:[["Sportsbook","sportsbook"],["Digital Casino","casino"],["Racebook","horses"],["Messaging","messaging"],["Dynamic Live","dynamicLive"],["Prop Plus","propPlus"],["Live Casino","liveCasino"]].map(([a,t])=>e.jsxs("div",{className:"switch-row",children:[e.jsx("span",{children:a}),e.jsxs("label",{className:"switch",children:[e.jsx("input",{type:"checkbox",checked:!!n[t],onChange:i=>x(t,i.target.checked)}),e.jsx("span",{className:"slider"})]})]},t))})]}),e.jsxs("div",{className:"col-card",children:[e.jsx("label",{children:"Website"}),e.jsx("input",{value:window.location.hostname,readOnly:!0}),e.jsx("label",{children:"Account Type"}),e.jsxs("select",{value:n.accountType,onChange:a=>x("accountType",a.target.value),children:[e.jsx("option",{value:"credit",children:"Credit"}),e.jsx("option",{value:"post_up",children:"Post Up"})]}),e.jsx("label",{children:"Min bet"}),e.jsx("input",{type:"number",value:n.minBet,onChange:a=>x("minBet",a.target.value)}),e.jsx("label",{children:"Max bet"}),e.jsx("input",{type:"number",value:n.wagerLimit,onChange:a=>x("wagerLimit",a.target.value)}),e.jsx("label",{children:"Credit Limit"}),e.jsx("input",{type:"number",value:n.creditLimit,onChange:a=>x("creditLimit",a.target.value)}),e.jsx("label",{children:"Settle Limit"}),e.jsx("input",{type:"number",value:n.settleLimit,onChange:a=>x("settleLimit",a.target.value)}),e.jsx("label",{children:"Zero Balance / Weekly"}),e.jsxs("select",{value:n.zeroBalanceWeekly,onChange:a=>x("zeroBalanceWeekly",a.target.value),children:[e.jsx("option",{value:"standard",children:"Standard"}),e.jsx("option",{value:"zero_balance",children:"Zero Balance"}),e.jsx("option",{value:"weekly",children:"Weekly"})]}),e.jsx("label",{children:"Temporary Credit"}),e.jsx("input",{type:"number",value:n.tempCredit,onChange:a=>x("tempCredit",a.target.value)})]}),e.jsxs("div",{className:"col-card",children:[e.jsxs("div",{className:"switch-row inline-top",children:[e.jsx("span",{children:"Enable Captcha"}),e.jsxs("label",{className:"switch",children:[e.jsx("input",{type:"checkbox",checked:n.enableCaptcha,onChange:a=>x("enableCaptcha",a.target.checked)}),e.jsx("span",{className:"slider"})]})]}),e.jsx("label",{children:"Crypto Promo (%)"}),e.jsx("input",{type:"number",value:n.cryptoPromoPct,onChange:a=>x("cryptoPromoPct",a.target.value)}),e.jsx("label",{children:"Promo Type"}),e.jsxs("select",{value:n.promoType,onChange:a=>x("promoType",a.target.value),children:[e.jsx("option",{value:"promo_credit",children:"Promo Credit"}),e.jsx("option",{value:"bonus_credit",children:"Bonus Credit"}),e.jsx("option",{value:"none",children:"None"})]}),e.jsx("label",{children:"Expires On"}),e.jsx("input",{type:"date",value:n.expiresOn,onChange:a=>x("expiresOn",a.target.value)}),e.jsx("label",{children:"Player Notes"}),e.jsx("textarea",{rows:9,placeholder:"For agent reference only",value:n.playerNotes,onChange:a=>x("playerNotes",a.target.value)}),e.jsx("label",{children:"Balance"}),e.jsx("input",{type:"number",value:o.balance??0,onChange:a=>F(t=>({...t,balance:Number(a.target.value||0)}))}),e.jsx("button",{className:"btn btn-user",onClick:Kn,children:"Update Balance"})]})]}),e.jsxs("div",{className:"apps-card",children:[e.jsx("h3",{className:"apps-title",children:"Apps"}),e.jsxs("div",{className:"apps-grid",children:[e.jsxs("div",{className:"apps-field",children:[e.jsx("label",{children:"Venmo:"}),e.jsx("input",{value:n.appsVenmo,onChange:a=>x("appsVenmo",a.target.value),placeholder:"@username"})]}),e.jsxs("div",{className:"apps-field",children:[e.jsx("label",{children:"Cashapp:"}),e.jsx("input",{value:n.appsCashapp,onChange:a=>x("appsCashapp",a.target.value),placeholder:"$cashtag"})]}),e.jsxs("div",{className:"apps-field",children:[e.jsx("label",{children:"Apple Pay:"}),e.jsx("input",{value:n.appsApplePay,onChange:a=>x("appsApplePay",a.target.value),placeholder:"Phone or email"})]}),e.jsxs("div",{className:"apps-field",children:[e.jsx("label",{children:"Zelle:"}),e.jsx("input",{value:n.appsZelle,onChange:a=>x("appsZelle",a.target.value),placeholder:"Phone or email"})]}),e.jsxs("div",{className:"apps-field",children:[e.jsx("label",{children:"PayPal:"}),e.jsx("input",{value:n.appsPaypal,onChange:a=>x("appsPaypal",a.target.value),placeholder:"Email or @username"})]}),e.jsxs("div",{className:"apps-field",children:[e.jsx("label",{children:"BTC:"}),e.jsx("input",{value:n.appsBtc,onChange:a=>x("appsBtc",a.target.value),placeholder:"Wallet address"})]}),e.jsxs("div",{className:"apps-field apps-field-full",children:[e.jsx("label",{children:"Other:"}),e.jsx("input",{value:n.appsOther,onChange:a=>x("appsOther",a.target.value),placeholder:"Other handle"})]})]})]}),e.jsxs("div",{className:"bottom-line",children:[e.jsxs("span",{children:["Total Wagered: ",w(ca.totalWagered||0)]}),e.jsxs("span",{children:["Net: ",e.jsx("b",{className:T(ca.netProfit||0),children:w(ca.netProfit||0)})]})]})]}),Nn&&e.jsx("div",{className:"modal-overlay",onClick:()=>{De(!1),Me(!1),te(!0)},children:e.jsx("div",{className:"modal-card",onClick:a=>a.stopPropagation(),children:wn?(()=>{const a=je,t=en,i=ye,c=ea(i+(t.balanceDirection==="credit"?a:-a)),r=t.balanceDirection==="debit",d=new Date().toLocaleDateString("en-US",{month:"2-digit",day:"2-digit",year:"numeric"}).replace(/\//g,"-"),m=b?Fa:"Balance";return e.jsxs(e.Fragment,{children:[e.jsx("h4",{style:{marginBottom:"16px"},children:"Confirm Transaction"}),e.jsxs("div",{className:"tx-confirm-table",children:[e.jsxs("div",{className:"tx-confirm-row",children:[e.jsx("span",{children:"Date"}),e.jsx("span",{children:d})]}),e.jsxs("div",{className:"tx-confirm-row",children:[e.jsxs("span",{children:["Previous ",m]}),e.jsx("span",{style:{color:Ra(i)},children:w(i)})]}),e.jsxs("div",{className:"tx-confirm-row",children:[e.jsxs("span",{children:[t.label," :"]}),e.jsxs("span",{style:{color:Ra(c)},children:[r?"-":"",w(a)]})]}),t.value==="deposit"&&!b&&e.jsxs("div",{className:"tx-confirm-row",children:[e.jsx("span",{children:"Freeplay Bonus"}),e.jsx("span",{style:{color:Le?"#166534":"#6b7280"},children:Le?`${ta.percent}% (${w(ta.bonusAmount)})`:"Off"})]}),e.jsxs("div",{className:"tx-confirm-row tx-confirm-total",children:[e.jsxs("span",{children:["New ",m]}),e.jsx("span",{style:{color:Ra(c)},children:w(c)})]})]}),ae&&e.jsx("div",{style:{marginTop:"12px",marginBottom:"12px",background:"#fee2e2",color:"#991b1b",border:"1px solid #fecaca",borderRadius:"8px",padding:"10px 12px",fontWeight:600},children:ae}),e.jsxs("div",{className:"modal-actions",children:[e.jsx("button",{className:"btn btn-back",onClick:()=>Me(!1),children:"Cancel"}),e.jsx("button",{className:"btn btn-save",disabled:!tn||ba,onClick:ms,children:ba?"Saving…":"Confirm"})]})]})})():e.jsxs(e.Fragment,{children:[e.jsx("h4",{children:"New transaction"}),e.jsx("label",{children:"Transaction"}),e.jsx("select",{value:xa,onChange:a=>{ga(a.target.value),a.target.value==="deposit"&&te(!0),L("")},children:Ia.map(a=>e.jsx("option",{value:a.value,children:a.label},a.value))}),e.jsx("label",{children:"Amount"}),e.jsx("input",{type:"number",step:"1",min:"0",value:ha,onChange:a=>{ue(a.target.value===""?"":String(Math.round(Number(a.target.value)))),L("")},placeholder:"0"}),e.jsxs("div",{className:"tx-modal-balance-strip",role:"status","aria-live":"polite",children:[e.jsxs("div",{className:"tx-modal-balance-item",children:[e.jsx("span",{children:b?Fa:"Current Balance"}),e.jsx("b",{className:b?aa(ye):T(ye),style:{cursor:"pointer"},title:"Click to use this amount",onClick:()=>ue(Oa(ye)),children:w(ye)})]}),e.jsxs("div",{className:"tx-modal-balance-item",children:[e.jsx("span",{children:b?"Funding Wallet":"Carry"}),e.jsx("b",{className:b?T(Xe):T(Xe),style:{cursor:"pointer"},title:"Click to use this amount",onClick:()=>ue(Oa(Xe)),children:w(Xe)})]})]}),e.jsx("label",{children:"Description"}),e.jsx("input",{value:rt,onChange:a=>fa(a.target.value),placeholder:"Optional note"}),en.value==="deposit"&&!b&&e.jsxs("label",{style:{display:"flex",alignItems:"center",gap:"10px",marginTop:"14px",padding:"10px 12px",borderRadius:"10px",border:"1px solid #d1d5db",background:"#f9fafb",cursor:"pointer"},children:[e.jsx("input",{type:"checkbox",checked:Le,onChange:a=>te(a.target.checked)}),e.jsx("span",{style:{fontWeight:600,color:"#111827"},children:`${ta.percent}% Freeplay (${w(ta.bonusAmount)})`})]}),ae&&e.jsx("div",{style:{marginTop:"12px",marginBottom:"12px",background:"#fee2e2",color:"#991b1b",border:"1px solid #fecaca",borderRadius:"8px",padding:"10px 12px",fontWeight:600},children:ae}),e.jsxs("div",{className:"modal-actions",children:[e.jsx("button",{className:"btn btn-back",onClick:()=>{De(!1),te(!0)},children:"Cancel"}),e.jsx("button",{className:"btn btn-save",disabled:!tn,onClick:()=>{if(!an){L("Enter a valid amount greater than 0.");return}L(""),Me(!0)},children:"Next"})]})]})})}),Dn&&e.jsx("div",{className:"modal-overlay",onClick:()=>{ge(!1),Oe(!1)},children:e.jsx("div",{className:"modal-card",onClick:a=>a.stopPropagation(),children:Ln?(()=>{const a=$a,t=ns,i=Z,c=ea(i+(t?-a:a)),r=new Date().toLocaleDateString("en-US",{month:"2-digit",day:"2-digit",year:"numeric"}).replace(/\//g,"-");return e.jsxs(e.Fragment,{children:[e.jsx("h4",{style:{marginBottom:"16px"},children:"Confirm Free Play"}),e.jsxs("div",{className:"tx-confirm-table",children:[e.jsxs("div",{className:"tx-confirm-row",children:[e.jsx("span",{children:"Date"}),e.jsx("span",{children:r})]}),e.jsxs("div",{className:"tx-confirm-row",children:[e.jsx("span",{children:"Previous Balance"}),e.jsx("span",{style:{color:Xt(i)},children:w(i)})]}),e.jsxs("div",{className:"tx-confirm-row",children:[e.jsxs("span",{children:[t?"Withdrawals":"Deposits"," :"]}),e.jsxs("span",{style:{color:t?"#dc2626":"#1f2937"},children:[t?"-":"",w(a)]})]}),e.jsxs("div",{className:"tx-confirm-row tx-confirm-total",children:[e.jsx("span",{children:"New Balance"}),e.jsx("span",{style:{color:Xt(c)},children:w(c)})]})]}),se&&e.jsx("div",{style:{marginTop:"12px",marginBottom:"12px",background:"#fee2e2",color:"#991b1b",border:"1px solid #fecaca",borderRadius:"8px",padding:"10px 12px",fontWeight:600},children:se}),e.jsxs("div",{className:"modal-actions",children:[e.jsx("button",{className:"btn btn-back",onClick:()=>Oe(!1),children:"Cancel"}),e.jsx("button",{className:"btn btn-save",disabled:!sn,onClick:is,children:"Confirm"})]})]})})():e.jsxs(e.Fragment,{children:[e.jsx("h4",{children:re==="withdraw"?"Withdraw Free Play":"New Free Play"}),e.jsx("label",{children:"Transaction"}),e.jsx("div",{className:"fp-modal-type-badge",style:{background:re==="withdraw"?"#fee2e2":void 0,color:re==="withdraw"?"#dc2626":void 0},children:re==="withdraw"?"Withdraw":"Deposit"}),e.jsx("label",{children:"Amount"}),e.jsx("input",{type:"number",step:"1",min:"0",value:Na,onChange:a=>{wa(a.target.value===""?"":String(Math.round(Number(a.target.value)))),C("")},placeholder:"0"}),e.jsx("div",{className:"tx-modal-balance-strip fp-modal-balance-strip",role:"status","aria-live":"polite",children:e.jsxs("div",{className:"tx-modal-balance-item",children:[e.jsx("span",{children:"Free Play Balance"}),e.jsx("b",{className:T(Z),style:{cursor:"pointer"},title:"Click to use this amount",onClick:()=>wa(Oa(Z)),children:w(Z)})]})}),e.jsx("label",{children:"Description"}),e.jsx("input",{value:_e,onChange:a=>xt(a.target.value),placeholder:"Optional note"}),se&&e.jsx("div",{style:{marginTop:"12px",marginBottom:"12px",background:"#fee2e2",color:"#991b1b",border:"1px solid #fecaca",borderRadius:"8px",padding:"10px 12px",fontWeight:600},children:se}),e.jsxs("div",{className:"modal-actions",children:[e.jsx("button",{className:"btn btn-back",onClick:()=>ge(!1),children:"Cancel"}),e.jsx("button",{className:"btn btn-save",disabled:!sn,onClick:()=>{if(!nn){C("Enter a valid free play amount greater than 0.");return}C(""),Oe(!0)},children:"Next"})]})]})})}),e.jsx("style",{children:`
      ...
      `})]}):e.jsx("div",{className:"admin-view",children:e.jsx("div",{className:"view-content",children:"User not found."})})}export{ei as default};

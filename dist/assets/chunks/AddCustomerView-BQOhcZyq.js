import{b as d,j as e}from"./vendor-common-DIOJvOBD.js";import{j as Qe,r as Te,m as Ee,s as Re,x as me,ap as Ct,aq as kt,H as Ye,ar as Ge,as as It,k as Pt}from"./app-api-CcnS6dzu.js";import{m as Lt,F as Ve,G as Mt,H as Ut}from"./utils-shared-B0gEc-Fw.js";const Be=s=>{const l=String(s||"").toUpperCase().replace(/[^A-Z0-9]/g,"");if(!l)return"";const f=l.match(/^[A-Z]+/);return f&&f[0]?f[0]:l.replace(/\d+$/,"")||l},Tt=s=>s?`FREEPLAY

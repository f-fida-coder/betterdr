import{b as d,j as e}from"./vendor-common-DIOJvOBD.js";import{j as Qe,s as Te,m as Ee,t as Re,y as me,ar as Ct,as as kt,J as He,at as Ge,au as It,k as Pt}from"./app-api-B9s2v2K1.js";import{n as Lt,G as Ve,H as Mt,I as Ut}from"./utils-shared-F8fLIMAz.js";import"./contexts-shared-B_WhXKtZ.js";const Be=s=>{const l=String(s||"").toUpperCase().replace(/[^A-Z0-9]/g,"");if(!l)return"";const f=l.match(/^[A-Z]+/);return f&&f[0]?f[0]:l.replace(/\d+$/,"")||l},Tt=s=>s?`FREEPLAY

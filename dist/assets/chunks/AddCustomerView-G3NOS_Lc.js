import{r as d,j as e}from"./vendor-react-Bd2HVIcR.js";import{y as Ze,F as Ee,C as Re,G as Be,L as ue,aK as Ct,aL as It,Y as Ge,aM as Ve,aN as Pt,z as Lt}from"./app-api-BxannenG.js";import{at as Mt,aM as Qe,aN as Ut,aO as Tt}from"./utils-shared-a_duALCJ.js";import{a as Et}from"./contexts-shared-CC5AGxHR.js";import"./vendor-common-_eGvg4ul.js";import"./dashboard-views-BMDkgNxy.js";import"./scoreboard-views-DRlZHfDa.js";const $e=o=>{const c=String(o||"").toUpperCase().replace(/[^A-Z0-9]/g,"");if(!c)return"";const u=c.match(/^[A-Z]+/);return u&&u[0]?u[0]:c.replace(/\d+$/,"")||c},Rt=o=>o?`FREEPLAY

import{b as d,j as e}from"./vendor-common-DIOJvOBD.js";import{m as Qe,x as Te,t as Ee,y as Re,E as me,au as Ct,av as kt,O as He,aw as Ve,ax as It,o as Pt}from"./app-api-onDgO3AX.js";import{q as Lt,I as Ge,J as Mt,K as Ut}from"./utils-shared-Dq7g-LvP.js";const Be=s=>{const l=String(s||"").toUpperCase().replace(/[^A-Z0-9]/g,"");if(!l)return"";const f=l.match(/^[A-Z]+/);return f&&f[0]?f[0]:l.replace(/\d+$/,"")||l},Tt=s=>s?`FREEPLAY

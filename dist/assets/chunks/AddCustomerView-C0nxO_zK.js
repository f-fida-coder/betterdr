import{r as d,j as e}from"./vendor-react-Bd2HVIcR.js";import{v as Qe,C as Te,y as Ee,D as Re,I as me,ax as Ct,ay as kt,S as He,az as Ve,aA as It,w as Pt}from"./app-api-CY7G0v-c.js";import{x as Lt,O as Ge,P as Mt,Q as Ut}from"./utils-shared-BCdVUkZZ.js";import"./vendor-common-_eGvg4ul.js";const Be=s=>{const l=String(s||"").toUpperCase().replace(/[^A-Z0-9]/g,"");if(!l)return"";const f=l.match(/^[A-Z]+/);return f&&f[0]?f[0]:l.replace(/\d+$/,"")||l},Tt=s=>s?`FREEPLAY

import{r as d,j as e}from"./vendor-react-Bd2HVIcR.js";import{y as Ze,F as Ee,C as Re,G as Be,L as ue,aK as Ct,aL as It,Y as Ge,aM as Ve,aN as Pt,z as Lt}from"./app-api-H9Dt6vPX.js";import{ao as Mt,aH as Qe,aI as Ut,aJ as Tt}from"./utils-shared-ClOZMuOZ.js";import{a as Et}from"./contexts-shared-Dnroh17g.js";import"./vendor-common-_eGvg4ul.js";import"./dashboard-views-B3i2vzJN.js";import"./scoreboard-views-CU_Jwgaw.js";const $e=o=>{const c=String(o||"").toUpperCase().replace(/[^A-Z0-9]/g,"");if(!c)return"";const u=c.match(/^[A-Z]+/);return u&&u[0]?u[0]:c.replace(/\d+$/,"")||c},Rt=o=>o?`FREEPLAY

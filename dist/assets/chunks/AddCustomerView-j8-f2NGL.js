import{b as d,j as e}from"./vendor-common-DIOJvOBD.js";import{l as Qe,v as Te,q as Ee,w as Re,C as me,au as Ct,av as kt,M as He,aw as Ge,ax as It,m as Pt}from"./app-api-D2SPk4eT.js";import{n as Lt,G as Ve,H as Mt,I as Ut}from"./utils-shared-CKyCFdi7.js";const Be=s=>{const l=String(s||"").toUpperCase().replace(/[^A-Z0-9]/g,"");if(!l)return"";const f=l.match(/^[A-Z]+/);return f&&f[0]?f[0]:l.replace(/\d+$/,"")||l},Tt=s=>s?`FREEPLAY

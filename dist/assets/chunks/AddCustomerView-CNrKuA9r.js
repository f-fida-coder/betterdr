import{r as d,j as e}from"./vendor-react-Bd2HVIcR.js";import{y as Ze,F as Ee,C as Re,G as Be,L as ue,aK as Ct,aL as It,Y as Ge,aM as Ve,aN as Pt,z as Lt}from"./app-api-BxannenG.js";import{av as Mt,aO as Qe,aP as Ut,aQ as Tt}from"./utils-shared-CTqOHk7s.js";import{a as Et}from"./contexts-shared-DcFurW4A.js";import"./vendor-common-_eGvg4ul.js";import"./dashboard-views-DPZYn9la.js";import"./scoreboard-views-y8fYFvQc.js";const $e=o=>{const c=String(o||"").toUpperCase().replace(/[^A-Z0-9]/g,"");if(!c)return"";const u=c.match(/^[A-Z]+/);return u&&u[0]?u[0]:c.replace(/\d+$/,"")||c},Rt=o=>o?`FREEPLAY

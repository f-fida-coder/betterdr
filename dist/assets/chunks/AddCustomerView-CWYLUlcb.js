import{r as d,j as e}from"./vendor-react-Bd2HVIcR.js";import{t as Qe,B as Te,x as Ee,C as Re,H as me,aw as Ct,ax as kt,R as He,ay as Ve,az as It,v as Pt}from"./app-api-DfDI8Deg.js";import{q as Lt,J as Ge,K as Mt,L as Ut}from"./utils-shared-DbtEWpev.js";import"./vendor-common-_eGvg4ul.js";const Be=s=>{const l=String(s||"").toUpperCase().replace(/[^A-Z0-9]/g,"");if(!l)return"";const f=l.match(/^[A-Z]+/);return f&&f[0]?f[0]:l.replace(/\d+$/,"")||l},Tt=s=>s?`FREEPLAY

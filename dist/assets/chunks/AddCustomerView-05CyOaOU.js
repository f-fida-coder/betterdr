import{r as d,j as e}from"./vendor-react-Bd2HVIcR.js";import{y as Ze,F as Ee,C as Re,G as Be,L as ue,aK as Ct,aL as It,Y as Ge,aM as Ve,aN as Pt,z as Lt}from"./app-api-H9Dt6vPX.js";import{ag as Mt,ay as Qe,az as Ut,aA as Tt}from"./utils-shared-C4nvRG-C.js";import{a as Et}from"./contexts-shared-DVV0_92i.js";import"./vendor-common-_eGvg4ul.js";import"./dashboard-views-C83gLXlg.js";import"./scoreboard-views-B41TdRRS.js";const $e=o=>{const c=String(o||"").toUpperCase().replace(/[^A-Z0-9]/g,"");if(!c)return"";const u=c.match(/^[A-Z]+/);return u&&u[0]?u[0]:c.replace(/\d+$/,"")||c},Rt=o=>o?`FREEPLAY

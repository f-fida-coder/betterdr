import{r as d,j as e,g as Qe,e as Te,c as Ee,f as Re,Y as me,a8 as Ct,a9 as kt,aa as He,ab as Ve,ac as It,a as Pt}from"./index-vZr0KL47.js";import{n as Ge,f as Lt,g as Mt}from"./identityPassword-CHxhYAaE.js";import{a as Ut}from"./AdminPanel-BIVOuVjA.js";const Be=s=>{const l=String(s||"").toUpperCase().replace(/[^A-Z0-9]/g,"");if(!l)return"";const f=l.match(/^[A-Z]+/);return f&&f[0]?f[0]:l.replace(/\d+$/,"")||l},Tt=s=>s?`FREEPLAY

...
`;navigator.clipboard.writeText(J).then(()=>alert("Copied to clipboard!"))},children:"Copy Info"})]})]})]})}),we&&e.jsx("div",{className:"modal-overlay",children:e.jsxs("div",{className:"modal-content bulk-edit-modal",children:[e.jsxs("h3",{children:["Edit ",_e()]}),e.jsxs("form",{onSubmit:Bt,children:[e.jsxs("div",{className:"form-group",children:[e.jsx("label",{children:_e()}),q==="status"?e.jsxs("select",{value:he,onChange:S=>Ne(S.target.value),required:!0,children:[e.jsx("option",{value:"",children:"Select status"}),e.jsx("option",{value:"active",children:"Active"}),e.jsx("option",{value:"disabled",children:"Disabled"}),e.jsx("option",{value:"read_only",children:"Read Only"})]}):e.jsx("input",{type:"number",step:"1",min:q==="balanceAdjust"?void 0:"0",value:he,onChange:S=>Ne(S.target.value),placeholder:q==="balanceAdjust"?"Enter + / - amount":"Enter amount",required:!0})]}),e.jsx("p",{className:"bulk-edit-hint",children:q==="balanceAdjust"?"This adds or subtracts from balance for all players shown in the current list.":"This updates all players shown in the current list."}),e.jsxs("div",{className:"form-actions",children:[e.jsx("button",{type:"submit",className:"btn-primary",disabled:N==="bulk-update",children:N==="bulk-update"?"Saving...":"Save"}),e.jsx("button",{type:"button",className:"btn-secondary",onClick:()=>Je(!1),children:"Cancel"})]})]})]})}),ve.open&&e.jsx("div",{className:"modal-overlay",children:e.jsxs("div",{className:"modal-content bulk-edit-modal",children:[e.jsxs("h3",{children:["Edit ",ve.type==="name"?"Name":ve.type==="password"?"Password":"Balance",": ",ve.username]}),e.jsxs("form",{onSubmit:Ma,children:[e.jsxs("div",{className:"form-group",children:[e.jsx("label",{children:ve.type==="name"?"Name":ve.type==="password"?"Password":"Balance"}),e.jsx("input",{type:ve.type==="balance"?"number":"text",value:ve.value,onChange:S=>Te(J=>({...J,value:ve.type==="password"?S.target.value.toUpperCase():S.target.value})),autoFocus:!0,required:!0})]}),e.jsxs("div",{className:"form-actions",children:[e.jsx("button",{type:"submit",className:"btn-primary",disabled:N===ve.customerId,children:N===ve.customerId?"Saving...":"Save"}),e.jsx("button",{type:"button",className:"btn-secondary",onClick:()=>Te({open:!1,type:"",customerId:null,username:"",value:""}),children:"Cancel"})]})]})]})}),Oe&&e.jsx("div",{className:"modal-overlay",children:e.jsxs("div",{className:"modal-glass-content",children:[e.jsxs("h3",{children:["Adjust Balance: ",le.username]}),e.jsxs("form",{onSubmit:kt,children:[e.jsxs("div",{className:"premium-field-info",children:[e.jsx("label",{children:"Current Net Balance"}),e.jsx("div",{className:`large-val ${Tt(le.currentBalance)}`,children:jt(le.currentBalance)})]}),e.jsxs("div",{className:"p-field",children:[e.jsx("label",{children:"New Net Balance"}),e.jsxs("div",{className:"input-with-symbol",children:[e.jsx("span",{className:"sym",children:"$"}),e.jsx("input",{type:"number",step:"0.01",value:le.nextBalance,onChange:S=>l({...le,nextBalance:S.target.value}),autoFocus:!0,required:!0})]}),e.jsx("small",{className:"field-hint",children:"Setting a new net balance will adjust the credit/owed amount accordingly."})]}),e.jsxs("div",{className:"modal-premium-actions",children:[e.jsx("button",{type:"submit",className:"btn-save-premium",disabled:N!==null,children:N!==null?"Updating...":"Confirm Adjustment"}),e.jsx("button",{type:"button",className:"btn-cancel-premium",onClick:()=>P(!1),children:"Cancel"})]})]})]})}),e.jsx("style",{children:`
        .premium-admin-theme { 
          background: #0f172a; 
      ...
      `})]})]})]})}const Xa=a=>{const n=Number(a);return Number.isFinite(n)?Math.round(n*100)/100:0},El=a=>{const n=Number(a);return Number.isFinite(n)?Math.round(n*1e4)/1e4:0},As=(a,n)=>{const i=Number(a);return Number.isFinite(i)?i:n},rr=(a,n)=>{const i=a&&typeof a=="object"&&a.settings&&typeof a.settings=="object"?a.settings:{},p=i.freePlayPercent??a?.freePlayPercent??20,g=El(Math.max(0,As(p,20))),x=Xa(Math.max(0,As(n,0))),v=i.maxFpCredit??a?.maxFpCredit??null,w=v===null?0:As(v,0),f=v===null||w<=0,B=Xa(Math.max(0,w)),h=Xa(x*(g/100));let N=0;return g>0&&h>0&&(f?N=h:B>0&&(N=Math.min(h,B))),{bonusAmount:Xa(Math.max(0,N)),percent:g,cap:B,depositAmount:x,unlimited:f}},$l=[{value:"deposit",label:"Deposit"},{value:"withdrawal",label:"Withdraw"},{value:"credit_adj",label:"Credit Adj"},{value:"debit_adj",label:"Debit Adj"},{value:"fp_deposit",label:"FP Deposit"}],Rl=10,Ul=(a=new Date)=>{const n=new Date(a);if(Number.isNaN(n.getTime()))return"";const i=n.getFullYear(),p=String(n.getMonth()+1).padStart(2,"0"),g=String(n.getDate()).padStart(2,"0");return`${i}-${p}-${g}`},es={deposit:"Customer Deposit",withdrawal:"Customer Withdrawal",credit_adj:"Customer Credit Adjustment",debit_adj:"Customer Debit Adjustment",fp_deposit:"Customer Freeplay Deposit"},Ps=(a,n="")=>({id:a,agentId:n,searchQuery:"",selectedUserId:"",type:"deposit",applyDepositFreeplayBonus:!0,amount:"",figureDate:Ul(),description:es.deposit,searchOpen:!1,busy:!1,error:""});function _l(){const[a,n]=t.useState("admin"),[i,p]=t.useState([]),[g,x]=t.useState([]),[v,w]=t.useState("manual"),[f,B]=t.useState(""),[h,N]=t.useState({}),[m,u]=t.useState(()=>Array.from({length:Rl},(P,le)=>Ps(`manual-${le+1}`))),[k,G]=t.useState({}),[D,F]=t.useState({totalDeposits:0,totalWithdrawals:0,pendingCount:0}),[C,j]=t.useState([]),[W,r]=t.useState([]),[M,T]=t.useState(!0),[o,U]=t.useState(!1),[ae,z]=t.useState(""),[y,K]=t.useState(""),c=t.useMemo(()=>{const P=new Map;for(const le of i){const l=String(le.id||"");l&&P.set(l,le)}return P},[i]),E=t.useMemo(()=>{const P=f.trim().toLowerCase();return P?g.filter(le=>{const l=String(le.username||"").toLowerCase(),q=String(le.phoneNumber||"").toLowerCase();return l.includes(P)||q.includes(P)}):g},[g,f]),O=async(P,le)=>{if(le==="admin")try{const l=await ui(P);F({totalDeposits:Number(l?.totalDeposits||0),totalWithdrawals:Number(l?.totalWithdrawals||0),pendingCount:Number(l?.pendingCount||0)})}catch{}},_=async(P,le)=>{if(le!=="admin"){j(W);return}try{const l=await Da({user:"",type:"all",status:"all",time:"30d",limit:30},P);j(Array.isArray(l?.transactions)?l.transactions:[])}catch{j(W)}},H=async()=>{const P=localStorage.getItem("token");if(!P){z("Please login to view cashier data."),T(!1);return}try{T(!0),z("");const le=await zt(P),l=String(le?.role||"admin");n(l);let q=[];if(l==="admin"?q=await qt(P):q=await pa(P),p(Array.isArray(q)?q:[]),l==="admin"||l==="master_agent"||l==="super_agent")try{const re=await Yt(P),he=Array.isArray(re)?re:[];x(he),N(Ne=>{const we={...Ne};for(const Je of he){const ze=String(Je.id||"");ze&&typeof we[ze]!="boolean"&&(we[ze]=!1)}return we}),G(Ne=>{const we={...Ne};for(const Je of he){const ze=String(Je.id||"");ze&&!we[ze]&&(we[ze]=Ps(ze,ze))}return we})}catch{x([])}else x([]);await Promise.all([O(P,l),_(P,l)])}catch(le){z(le.message||"Failed to load cashier data")}finally{T(!1)}};t.useEffect(()=>{H()},[]),t.useEffect(()=>{a!=="admin"&&j(W)},[W,a]);const ue=P=>{if(P==null)return"—";const le=Number(P);return Number.isNaN(le)?"—":`$${le.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}`},De=P=>{const le=String(P.searchQuery||"").trim().toLowerCase();return i.filter(re=>P.agentId?String(re?.agentId?.id||re?.agentId||"")===String(P.agentId):!0).filter(re=>{if(!le)return!0;const he=String(re.username||"").toLowerCase(),Ne=String(re.fullName||`${re.firstName||""} ${re.lastName||""}`).toLowerCase(),we=String(re.phoneNumber||"").toLowerCase();return he.includes(le)||Ne.includes(le)||we.includes(le)}).slice(0,12)},Y=P=>{const le=String(P?.reason||"").toUpperCase(),l=String(P?.type||"").toLowerCase();return le==="FREEPLAY_ADJUSTMENT"||le==="DEPOSIT_FREEPLAY_BONUS"||le==="REFERRAL_FREEPLAY_BONUS"||le==="NEW_PLAYER_FREEPLAY_BONUS"?"FP Deposit":le==="CASHIER_DEPOSIT"||l==="deposit"?"Deposit":le==="CASHIER_WITHDRAWAL"||l==="withdrawal"?"Withdraw":le==="CASHIER_CREDIT_ADJUSTMENT"?"Credit Adj":le==="CASHIER_DEBIT_ADJUSTMENT"?"Debit Adj":"Adjustment"},$=P=>P==="deposit"||P==="credit_adj",ee=P=>{const le=Number(P);return Number.isFinite(le)?Math.round(le*100)/100:0},ge=(P,le,l=!1)=>{if(l){G(q=>{const re=q[P];return re?{...q,[P]:le(re)}:q});return}u(q=>q.map(re=>re.id===P?le(re):re))},Z=async(P,le=!1)=>{const l=localStorage.getItem("token");if(!l){z("Please login to continue.");return}const q=Number(P.amount||0),re=String(P.selectedUserId||""),he=c.get(re);if(!he){ge(P.id,Ye=>({...Ye,error:"Select a customer first."}),le);return}if(!Number.isFinite(q)||q<=0){ge(P.id,Ye=>({...Ye,error:"Enter a valid amount."}),le);return}const Ne=Number(he.balance||0),we=Number(he.freeplayBalance||0),Je=(P.description||"").trim()||es[P.type],ze=P.figureDate?`${Je} (Figure Date: ${P.figureDate})`:Je;ge(P.id,Ye=>({...Ye,busy:!0,error:""}),le),U(!0),z(""),K("");try{let Ye=Ne,dt=we,tt="CASHIER_CREDIT_ADJUSTMENT",Ze="adjustment",Re=0,ht=0;if(P.type==="fp_deposit"){const Ve=await qn(re,{operationMode:"transaction",amount:q,direction:"credit",description:ze},l),He=Number(Ve?.user?.freeplayBalance);Number.isFinite(He)?dt=He:dt=ee(we+q)}else{const Ve=$(P.type);Ye=ee(Ne+(Ve?q:-q)),P.type==="deposit"?(tt="CASHIER_DEPOSIT",Ze="deposit"):P.type==="withdrawal"?(tt="CASHIER_WITHDRAWAL",Ze="withdrawal"):P.type==="credit_adj"?(tt="CASHIER_CREDIT_ADJUSTMENT",Ze="adjustment"):(tt="CASHIER_DEBIT_ADJUSTMENT",Ze="adjustment");const He=await ha(re,{operationMode:"transaction",amount:q,direction:Ve?"credit":"debit",type:Ze,reason:tt,description:ze,applyDepositFreeplayBonus:P.type==="deposit"&&!le?P.applyDepositFreeplayBonus!==!1:!1},l),at=Number(He?.user?.balance);Number.isFinite(at)&&(Ye=at);const Xe=Number(He?.user?.freeplayBalance);Number.isFinite(Xe)&&(dt=Xe),Re=Number(He?.freeplayBonus?.amount||0),ht=Number(He?.referralBonus?.amount||0)}p(Ve=>Ve.map(He=>String(He.id||"")!==re?He:{...He,balance:Ye,freeplayBalance:dt}));const bt=[{id:`${Date.now()}-${Math.random().toString(36).slice(2,8)}`,type:P.type==="deposit"?"deposit":P.type==="withdrawal"?"withdrawal":"adjustment",user:he.username,userId:re,amount:q,date:new Date().toISOString(),status:"completed",reason:P.type==="fp_deposit"?"FREEPLAY_ADJUSTMENT":tt,description:ze}];Re>0&&bt.unshift({id:`${Date.now()}-${Math.random().toString(36).slice(2,8)}-fp`,type:"adjustment",user:he.username,userId:re,amount:Re,date:new Date().toISOString(),status:"completed",reason:"DEPOSIT_FREEPLAY_BONUS",description:"Auto free play bonus from deposit"}),r(Ve=>[...bt,...Ve].slice(0,30)),await Promise.all([O(l,a),_(l,a)]),ge(P.id,Ve=>({...Ve,amount:"",applyDepositFreeplayBonus:!0,description:es[Ve.type],busy:!1,error:""}),le);const lt=[`Transaction applied for ${he.username}.`];Re>0&&lt.push(`Auto free play bonus added: ${ue(Re)}.`),ht>0&&lt.push(`Referral bonus granted: ${ue(ht)}.`),K(lt.join(" "))}catch(Ye){ge(P.id,dt=>({...dt,busy:!1,error:Ye.message||"Failed to apply transaction."}),le)}finally{U(!1)}},te=(P,le,l)=>{const q=De(P);return e.jsxs("div",{className:"cashier-customer-cell",children:[e.jsx("button",{type:"button",className:"cashier-find-btn",children:"Find"}),e.jsxs("div",{className:"cashier-customer-search",children:[e.jsx("input",{type:"text",placeholder:"Search ...",value:P.searchQuery,onFocus:()=>le({...P,searchOpen:!0}),onBlur:()=>setTimeout(()=>le({...P,searchOpen:!1}),120),onChange:re=>le({...P,searchQuery:re.target.value,searchOpen:!0,selectedUserId:""})}),P.searchOpen&&e.jsx("div",{className:"cashier-search-dropdown",children:q.length===0?e.jsx("div",{className:"cashier-search-empty",children:"No matching users"}):q.map(re=>{const he=String(re.id||"");return e.jsxs("button",{type:"button",className:"cashier-search-item",onMouseDown:()=>l(re),children:[e.jsx("span",{children:String(re.username||"").toUpperCase()}),e.jsx("small",{children:re.fullName||`${re.firstName||""} ${re.lastName||""}`})]},he)})})]})]})},Oe=(P,le=!1)=>{const l=c.get(String(P.selectedUserId||"")),q=Number(l?.balanceOwed||0),re=Number(l?.balance||0),he=le?null:rr(l,Number(P.amount||0)),Ne=we=>{ge(P.id,()=>we,le)};return e.jsxs("tr",{children:[e.jsx("td",{children:te(P,Ne,we=>{const Je=String(we.id||"");Ne({...P,selectedUserId:Je,searchQuery:we.username||"",searchOpen:!1,error:""})})}),e.jsx("td",{className:"cashier-num",children:l?ue(q):"--"}),e.jsx("td",{className:"cashier-num",children:l?ue(re):"--"}),e.jsx("td",{children:e.jsx("select",{value:P.type,onChange:we=>Ne({...P,type:we.target.value,description:es[we.target.value]||P.description}),children:$l.filter(we=>!le||we.value!=="fp_deposit").map(we=>e.jsx("option",{value:we.value,children:we.label},we.value))})}),e.jsx("td",{children:e.jsxs("div",{className:"cashier-amount-wrap",children:[e.jsx("input",{type:"number",min:"0",step:"0.01",placeholder:"Amount",value:P.amount,onChange:we=>Ne({...P,amount:we.target.value})}),e.jsx("button",{type:"button",className:"cashier-zero-btn",onClick:()=>Ne({...P,amount:"0"}),children:"Zero"})]})}),e.jsx("td",{children:e.jsx("input",{type:"date",value:P.figureDate,onChange:we=>Ne({...P,figureDate:we.target.value})})}),e.jsxs("td",{children:[e.jsx("input",{type:"text",placeholder:"Description",value:P.description,onChange:we=>Ne({...P,description:we.target.value})}),P.type==="deposit"&&!le&&he&&e.jsxs("label",{style:{display:"flex",alignItems:"center",gap:"8px",marginTop:"8px",fontSize:"12px",color:"#111827",cursor:"pointer"},children:[e.jsx("input",{type:"checkbox",checked:P.applyDepositFreeplayBonus!==!1,onChange:we=>Ne({...P,applyDepositFreeplayBonus:we.target.checked})}),e.jsx("span",{children:`${he.percent}% Freeplay (${ue(he.bonusAmount)})`})]})]}),e.jsxs("td",{children:[e.jsx("button",{type:"button",className:"cashier-continue-btn",disabled:P.busy||o,onClick:()=>Z(P,le),children:P.busy?"Saving...":"Continue"}),P.error&&e.jsx("div",{className:"cashier-row-error",children:P.error})]})]},P.id)};return e.jsxs("div",{className:"admin-view",children:[e.jsx("div",{className:"view-header",children:e.jsx("h2",{children:"Cashier"})}),e.jsxs("div",{className:"view-content cashier-v2",children:[M&&e.jsx("div",{style:{padding:"20px",textAlign:"center"},children:"Loading cashier data..."}),!M&&e.jsxs(e.Fragment,{children:[ae&&e.jsx("div",{className:"alert error",children:ae}),y&&e.jsx("div",{className:"alert success",children:y}),e.jsxs("div",{className:"cashier-summary",children:[e.jsxs("div",{className:"summary-card",children:[e.jsx("h3",{children:"Total Deposits (Today)"}),e.jsx("p",{className:"amount",children:ue(D.totalDeposits)})]}),e.jsxs("div",{className:"summary-card",children:[e.jsx("h3",{children:"Total Withdrawals (Today)"}),e.jsx("p",{className:"amount",children:ue(D.totalWithdrawals)})]}),e.jsxs("div",{className:"summary-card",children:[e.jsx("h3",{children:"Pending Transactions"}),e.jsx("p",{className:"amount",children:Number(D.pendingCount||0)})]})]}),e.jsxs("div",{className:"cashier-top-filters",children:[e.jsxs("div",{className:"cashier-agent-filter",children:[e.jsx("span",{children:"Agents"}),e.jsx("input",{type:"text",placeholder:"Search ...",value:f,onChange:P=>B(P.target.value)})]}),e.jsxs("select",{value:v,onChange:P=>w(P.target.value),children:[e.jsx("option",{value:"manual",children:"Manual Mode"}),e.jsx("option",{value:"agent",children:"Agent Mode"})]})]}),v==="manual"?e.jsx("div",{className:"cashier-grid-wrap",children:e.jsxs("table",{className:"data-table cashier-entry-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Customer"}),e.jsx("th",{children:"Settle"}),e.jsx("th",{children:"Balance"}),e.jsx("th",{children:"Transaction"}),e.jsx("th",{children:"Amount"}),e.jsx("th",{children:"Figure Date"}),e.jsx("th",{children:"Description"}),e.jsx("th",{children:"Action"})]})}),e.jsx("tbody",{children:m.map(P=>Oe(P,!1))})]})}):e.jsx("div",{className:"cashier-agent-mode",children:E.length===0?e.jsx("div",{className:"cashier-empty",children:"No agents found."}):E.map(P=>{const le=String(P.id||""),l=k[le]||Ps(le,le),q=!!h[le];return e.jsxs("div",{className:"cashier-agent-card",children:[e.jsxs("button",{type:"button",className:"cashier-agent-head",onClick:()=>N(re=>({...re,[le]:!re[le]})),children:[e.jsx("span",{children:q?"−":"+"}),e.jsx("span",{children:String(P.username||"").toUpperCase()})]}),q&&e.jsx("div",{className:"cashier-agent-body",children:e.jsxs("table",{className:"data-table cashier-entry-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Customer"}),e.jsx("th",{children:"Settle"}),e.jsx("th",{children:"Balance"}),e.jsx("th",{children:"Transaction"}),e.jsx("th",{children:"Amount"}),e.jsx("th",{children:"Figure Date"}),e.jsx("th",{children:"Description"}),e.jsx("th",{children:"Action"})]})}),e.jsx("tbody",{children:Oe(l,!0)})]})})]},le)})}),e.jsxs("div",{className:"table-container",children:[e.jsx("h3",{children:"Recent Transactions"}),e.jsxs("table",{className:"data-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Type"}),e.jsx("th",{children:"User"}),e.jsx("th",{children:"Amount"}),e.jsx("th",{children:"Date"}),e.jsx("th",{children:"Status"}),e.jsx("th",{children:"Description"})]})}),e.jsx("tbody",{children:C.length===0?e.jsx("tr",{children:e.jsx("td",{colSpan:6,className:"empty-msg",children:"No recent transactions."})}):C.map(P=>{const le=Y(P),l=le==="Deposit"||le==="Credit Adj"||le==="FP Deposit";return e.jsxs("tr",{children:[e.jsx("td",{children:le}),e.jsx("td",{children:P.user||"Unknown"}),e.jsx("td",{className:l?"positive":"negative",children:ue(P.amount)}),e.jsx("td",{children:P.date?new Date(P.date).toLocaleString():"—"}),e.jsx("td",{children:e.jsx("span",{className:`badge ${P.status||"completed"}`,children:P.status||"completed"})}),e.jsx("td",{children:P.description||"—"})]},P.id)})})]})]})]})]})]})}const Ht=a=>String(a||"").toUpperCase(),$s=a=>{const n=String(a||"").replace(/\D/g,"");return n.length===0?"":n.length<=3?n:n.length<=6?`${n.slice(0,3)}-${n.slice(3)}`:`${n.slice(0,3)}-${n.slice(3,6)}-${n.slice(6,10)}`},Ls=a=>String(a||"").replace(/[^A-Z0-9]/g,""),Wl=a=>{const n=String(a||"").replace(/\D/g,"");return n?n.slice(-4):""},Rs=(a,n,i,p="")=>{const g=Ls(Ht(a)),x=Ls(Ht(n)),v=Wl(i);if(v==="")return"";if(g!==""&&x!=="")return`${g.slice(0,3)}${x.slice(0,3)}${v}`.toUpperCase();const w=Ls(Ht(p));return w!==""?`${w.slice(0,6)}${v}`.toUpperCase():""},Ds=a=>{const n=String(a||"").toUpperCase().replace(/[^A-Z0-9]/g,"");if(!n)return"";const i=n.match(/^[A-Z]+/);return i&&i[0]?i[0]:n.replace(/\d+$/,"")||n},Ol=a=>a?`FREEPLAY

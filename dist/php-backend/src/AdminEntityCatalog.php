...
final class AdminEntityCatalog
{
    public static function definitions(): array
    {
        return [
            ...
            self::item('transaction-history', 'Transaction History', ['transactions', 'deleted_transactions', 'users', 'agents'], ['GET /api/admin/transaction-history', 'GET /api/admin/transactions', 'DELETE /api/admin/transaction-history', 'DELETE /api/admin/transactions']),

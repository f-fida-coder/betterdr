...
class Preloader extends Phaser.Scene {
	...
	preload() {
		...
		app.gamecfg = {
			...
			decimals: 0,
			symbols_total: 9,
			symbol_width: scaleResolution(163),
...
class MainGame extends Phaser.Scene {
    ...
    create () {
	    ...
	    app.reel1 = createReel(scaleResolution(184), scaleResolution(130));
	    app.reel2 = createReel(scaleResolution(370), scaleResolution(130));
	    app.reel3 = createReel(scaleResolution(560), scaleResolution(130));
	    app.reel4 = createReel(scaleResolution(749), scaleResolution(130));
	    app.reel5 = createReel(scaleResolution(933), scaleResolution(130));
...
const initPaytable = () => {
	...
	app.paytable.background = app.add.sprite(scaleResolution(171), scaleResolution(121), 'paytable_background').setOrigin(0);	
	...
	app.paytable.c1.title = app.add.text(
    	...
    	{fontFamily: 'Upcfb', fontStyle: '', fontSize: scaleResolution(50), color: '#fbb30b'}
    ).setOrigin(0.5, 0);	

	const positionsSymbols = [
		[scaleResolution(220), scaleResolution(235)],
		[scaleResolution(220), scaleResolution(325)],
		[scaleResolution(220), scaleResolution(415)],
		[scaleResolution(220), scaleResolution(505)],
		[scaleResolution(510), scaleResolution(235)],
		[scaleResolution(510), scaleResolution(325)],
		[scaleResolution(510), scaleResolution(415)],
		[scaleResolution(510), scaleResolution(505)],
		[scaleResolution(780), scaleResolution(235)],
		[scaleResolution(780), scaleResolution(325)],
		[scaleResolution(780), scaleResolution(415)]
	];
	...
	app.gamecfg.symbols.forEach((sym, index) => {
		...
		for (i in positionsLables[index][1]) {
			const l = app.add.text(
				...
				'', 
		    	{fontFamily: 'Upcfb', fontStyle: '', fontSize: scaleResolution(22), color: '#fbb30b'}
		    ).setOrigin(0, 0);
			factor.add(l);
		}

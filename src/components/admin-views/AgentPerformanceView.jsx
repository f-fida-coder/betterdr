...
function AgentPerformanceView() {
  ...
  const [newAgent, setNewAgent] = useState({ username: '', email: '', password: '', fullName: '' });
  ...
  const handleCreateAgent = async () => {
    try {
      ...
      setNewAgent({ username: '', email: '', password: '', fullName: '' });
      setError('');
      ...
      <div className="view-content">
        ...
        <div className="filter-section">
          ...
          <button
            ...
            disabled={createLoading || !newAgent.username || !newAgent.email || !newAgent.password}
          >

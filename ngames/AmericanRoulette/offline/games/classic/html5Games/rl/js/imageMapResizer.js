...
(function(){
    function scaleImageMap(){
        ...
        function listenForResize(){
            ...
            /*if(!$("#bet_div").hasClass("bet_div_container_bet")){
                    debounce2();
            }*/

            /*$( "#spin_button" ).bind( "click", function() { debounce2();});
            $( "#bet_button" ).bind( "click", function() { debounce2();});
            $( "#zoom-out" ).bind( "click", function() { debounce2();});
            $( "#zoom-in" ).bind( "click", function() { debounce2();});
            $( "#zoom-out" ).bind( "touchstart", function() { debounce2();});
            $( "#zoom-in" ).bind( "touchstart", function() { debounce2();});
            $("#bet-map area").click( function (e) {

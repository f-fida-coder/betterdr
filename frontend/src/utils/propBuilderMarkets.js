...
export const GAME_PROP_SECTIONS = [
    // 2026-07-12 (PO): all alt-line ladders and the half/quarter/period/inning
    // totals ladders were removed here AND in MatchDetailView SECTION_DEFS —
    // the board's first page already carries the lines players need. Only
    // market TYPES the board can't express remain (full-game team totals,
    // 3-way ML, BTTS, DNB, Double Chance, first/last to score, cards/corners).

...
const LOCAL_GAME_META = {
    ...
    'aces-and-eights': {
        ...
        url: '/games/aces-and-eights/game/index.html?v=20260714b&GAMESESSION=platform%7CVPA8%7C1%7C1%7CPLATFORM%7Cen&LANG=en&GAMECODE=VPA8&SHOWCASHIER=0&SHOWHISTORY=0&SHOWTYPE=1&CURRENCY=USD,%24,%C2%A2,p,5,2&ACCOUNTID=1&NOEXIT=1',

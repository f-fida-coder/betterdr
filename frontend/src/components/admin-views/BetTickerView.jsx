    ...
    try {
      ...
      if (data && Array.isArray(data.bets)) {
        const mappedBets = data.bets.map(b => ({
          ...
          amount: `$${Math.ceil(parseFloat(b.amount))}`,
      ...
      <div className="view-content">
        ...
        <div className="ticker-summary">
          ...
          <div className="summary-stat">
            ...
            <span className="value">${Math.ceil(bets.reduce((sum, b) => sum + parseFloat(b.amount.replace(/[$,]/g, '')), 0)).toLocaleString(undefined, { maximumFractionDigits: 0 })}</span>
          </div>
          <div className="summary-stat">

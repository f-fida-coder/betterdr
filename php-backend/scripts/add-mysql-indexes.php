...
$indexes = [
    ...
    // matches: NO entries here on purpose. SqlRepository::ensureTable owns
    // the matches indexes (idx_matches_external_id/status/sport/start_time/
    // status_start/updated — self-healing on every boot). This list used to
    // create j_-prefixed twins of the exact same column sets; the duplicates
    // were dropped 2026-07-21 — do not re-add them.
];

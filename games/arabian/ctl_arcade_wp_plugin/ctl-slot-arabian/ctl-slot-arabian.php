<?php
    /*
    Plugin Name: CTL Arcade - Slot Arabian
    Plugin URI: http://www.codethislab.com/
    Description: Slot Arabian for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeSlotArabian {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-slot-arabian";
        private $_szPluginName              = "Slot Arabian";
        private $_szAspectRatio             = "25:13";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "bonus, bonus game, casino, wheel of fortune, gambling, html5 slot machine, instant win, money, poker, slot, slot machine, sweepstakes, videopoker, arabian";
    ...
    $g_oCTLArcadeSlotArabian =  new CTLArcadeSlotArabian();

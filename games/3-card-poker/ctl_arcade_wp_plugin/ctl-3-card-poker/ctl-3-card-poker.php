<?php
    /*
    Plugin Name: CTL Arcade - 3 Card Poker
    Plugin URI: http://www.codethislab.com/
    Description: 3 Card Poker for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcade3CardPoker{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-3-card-poker";
        private $_szPluginName              = "3 Card Poker";
        private $_szAspectRatio             = "11:5";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "3d game, blackjack, 3 Card Poker table, card, cards, casino, casino game, texas hold'em, gambling, html5 gambling, html5 3 Card Poker, html5 casino, mobile, poker, sweepstakes";
    ...
    $g_oCTLArcade3CardPoker =  new CTLArcade3CardPoker();

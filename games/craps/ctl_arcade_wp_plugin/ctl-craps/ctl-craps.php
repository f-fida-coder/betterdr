<?php
    /*
    Plugin Name: CTL Arcade - Craps
    Plugin URI: http://www.codethislab.com/
    Description: Craps for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeCraps{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-craps";
        private $_szPluginName              = "Craps";
        private $_szAspectRatio             = "15:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "3d game, craps, craps table, bet, instant win, casino, casino game, baccara, gambling, html5 gambling, html5 craps, html5 casino, mobile, poker, sweepstakes";
    ...
    $g_oCTLArcadeCraps =  new CTLArcadeCraps();
